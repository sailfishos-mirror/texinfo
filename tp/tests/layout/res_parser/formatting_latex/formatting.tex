...
\endgroup{}
\par\begingroup\obeycr\ttfamily\noindent{}example with empty and non empty args mix
\endgroup{}
\par\begingroup\obeycr\ttfamily\noindent{}s--mallexample
\endgroup{}
\texttt{@noindent} after smallexample.
\par\begingroup\obeycr\ttfamily\noindent{}\$ wget 'http://savannah.gnu.org/cgi-bin/viewcvs/config/config/config.guess?rev=HEAD\&content-type=text/plain'
