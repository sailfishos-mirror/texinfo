...
$result_trees{'format_in_titlepage_titlepage'}{'contents'}[2]{'extra'}{'node_content'}[0] = $result_trees{'format_in_titlepage_titlepage'}{'contents'}[2]{'args'}[0]{'contents'}[0];
$result_trees{'format_in_titlepage_titlepage'}{'contents'}[2]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'format_in_titlepage_titlepage'}{'contents'}[2]{'args'}[0]{'contents'}[0];
