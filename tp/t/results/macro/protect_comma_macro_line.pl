...
$result_trees{'protect_comma_macro_line'}{'contents'}[0]{'contents'}[3]{'contents'}[0]{'parent'} = $result_trees{'protect_comma_macro_line'}{'contents'}[0]{'contents'}[3];
$result_trees{'protect_comma_macro_line'}{'contents'}[0]{'contents'}[3]{'contents'}[1]{'parent'} = $result_trees{'protect_comma_macro_line'}{'contents'}[0]{'contents'}[3];
...
$result_trees{'protect_comma_macro_line'}{'contents'}[0]{'contents'}[5]{'contents'}[0]{'parent'} = $result_trees{'protect_comma_macro_line'}{'contents'}[0]{'contents'}[5];
$result_trees{'protect_comma_macro_line'}{'contents'}[0]{'contents'}[5]{'parent'} = $result_trees{'protect_comma_macro_line'}{'contents'}[0];
