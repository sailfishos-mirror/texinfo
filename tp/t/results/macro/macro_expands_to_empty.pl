...
$result_trees{'macro_expands_to_empty'}{'contents'}[0]{'contents'}[4]{'contents'}[0]{'parent'} = $result_trees{'macro_expands_to_empty'}{'contents'}[0]{'contents'}[4];
$result_trees{'macro_expands_to_empty'}{'contents'}[0]{'contents'}[4]{'parent'} = $result_trees{'macro_expands_to_empty'}{'contents'}[0];
