...
$result_trees{'form_feeds'}{'contents'}[0]{'contents'}[2]{'contents'}[2]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'form_feeds'}{'contents'}[0]{'contents'}[2]{'contents'}[2]{'args'}[0];
$result_trees{'form_feeds'}{'contents'}[0]{'contents'}[2]{'contents'}[2]{'args'}[0]{'parent'} = $result_trees{'form_feeds'}{'contents'}[0]{'contents'}[2]{'contents'}[2];
$result_trees{'form_feeds'}{'contents'}[0]{'contents'}[2]{'contents'}[2]{'parent'} = $result_trees{'form_feeds'}{'contents'}[0]{'contents'}[2];
