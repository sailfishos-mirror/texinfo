...
$result_trees{'two_macros_on_a_line'}{'contents'}[0]{'contents'}[3]{'contents'}[4]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'two_macros_on_a_line'}{'contents'}[0]{'contents'}[3]{'contents'}[4]{'args'}[0];
$result_trees{'two_macros_on_a_line'}{'contents'}[0]{'contents'}[3]{'contents'}[4]{'args'}[0]{'parent'} = $result_trees{'two_macros_on_a_line'}{'contents'}[0]{'contents'}[3]{'contents'}[4];
$result_trees{'two_macros_on_a_line'}{'contents'}[0]{'contents'}[3]{'contents'}[4]{'parent'} = $result_trees{'two_macros_on_a_line'}{'contents'}[0]{'contents'}[3];
