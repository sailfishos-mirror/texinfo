...
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[0]{'extra'}{'command'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3];
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[0]{'parent'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3];
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[1];
...
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[2]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[2]{'args'}[0];
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[2]{'args'}[0]{'parent'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[2];
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[2]{'parent'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3];
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'extra'}{'end_command'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[2];
