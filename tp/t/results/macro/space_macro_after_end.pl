...
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'args'}[0]{'parent'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3];
$result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[0]{'contents'}[0]{'parent'} = $result_trees{'space_macro_after_end'}{'contents'}[0]{'contents'}[3]{'contents'}[0];
