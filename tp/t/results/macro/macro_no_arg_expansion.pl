...
$result_trees{'macro_no_arg_expansion'}{'contents'}[0]{'contents'}[3]{'contents'}[0]{'parent'} = $result_trees{'macro_no_arg_expansion'}{'contents'}[0]{'contents'}[3];
$result_trees{'macro_no_arg_expansion'}{'contents'}[0]{'contents'}[3]{'parent'} = $result_trees{'macro_no_arg_expansion'}{'contents'}[0];
