...
$result_trees{'expansion_order'}{'contents'}[0]{'contents'}[2]{'contents'}[3]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'expansion_order'}{'contents'}[0]{'contents'}[2]{'contents'}[3]{'args'}[0];
$result_trees{'expansion_order'}{'contents'}[0]{'contents'}[2]{'contents'}[3]{'args'}[0]{'parent'} = $result_trees{'expansion_order'}{'contents'}[0]{'contents'}[2]{'contents'}[3];
$result_trees{'expansion_order'}{'contents'}[0]{'contents'}[2]{'contents'}[3]{'parent'} = $result_trees{'expansion_order'}{'contents'}[0]{'contents'}[2];
