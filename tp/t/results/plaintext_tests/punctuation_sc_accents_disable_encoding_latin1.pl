...
$result_nodes{'punctuation_sc_accents_disable_encoding_latin1'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'punctuation_sc_accents_disable_encoding_latin1'};
$result_nodes{'punctuation_sc_accents_disable_encoding_latin1'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'punctuation_sc_accents_disable_encoding_latin1'};
