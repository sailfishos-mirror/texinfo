...
$result_sectioning{'punctuation_sc_accents_to_utf8_usascii'}{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'punctuation_sc_accents_to_utf8_usascii'};
...
$result_nodes{'punctuation_sc_accents_to_utf8_usascii'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'punctuation_sc_accents_to_utf8_usascii'};
$result_nodes{'punctuation_sc_accents_to_utf8_usascii'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'punctuation_sc_accents_to_utf8_usascii'};
