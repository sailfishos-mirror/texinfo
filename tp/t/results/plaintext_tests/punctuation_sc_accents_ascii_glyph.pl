...
$result_sectioning{'punctuation_sc_accents_ascii_glyph'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'punctuation_sc_accents_ascii_glyph'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_ascii_glyph'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_prev'} = $result_sectioning{'punctuation_sc_accents_ascii_glyph'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_ascii_glyph'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_up'} = $result_sectioning{'punctuation_sc_accents_ascii_glyph'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_ascii_glyph'}{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'punctuation_sc_accents_ascii_glyph'};
