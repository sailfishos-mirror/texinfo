...
$result_nodes{'manual_simple_latin1_with_error'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'manual_simple_latin1_with_error'};
$result_nodes{'manual_simple_latin1_with_error'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'manual_simple_latin1_with_error'};
