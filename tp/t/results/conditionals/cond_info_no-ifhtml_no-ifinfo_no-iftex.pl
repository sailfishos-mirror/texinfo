...
$result_sectioning{'cond_info_no-ifhtml_no-ifinfo_no-iftex'}{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'cond_info_no-ifhtml_no-ifinfo_no-iftex'};
