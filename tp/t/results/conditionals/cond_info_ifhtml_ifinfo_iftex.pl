...
$result_trees{'cond_info_ifhtml_ifinfo_iftex'}{'contents'}[3]{'extra'}{'node_content'}[0] = $result_trees{'cond_info_ifhtml_ifinfo_iftex'}{'contents'}[3]{'args'}[0]{'contents'}[0];
$result_trees{'cond_info_ifhtml_ifinfo_iftex'}{'contents'}[3]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'cond_info_ifhtml_ifinfo_iftex'}{'contents'}[3]{'args'}[0]{'contents'}[0];
