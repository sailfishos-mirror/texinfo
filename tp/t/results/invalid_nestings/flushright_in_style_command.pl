...
$result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[0]{'extra'}{'command'} = $result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1];
...
$result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[1];
...
$result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[2]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[2]{'args'}[0];
$result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[2]{'args'}[0]{'parent'} = $result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[2];
$result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[2]{'parent'} = $result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1];
$result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'extra'}{'end_command'} = $result_trees{'flushright_in_style_command'}{'contents'}[0]{'contents'}[1]{'contents'}[2];
