...
$result_menus{'style_not_closed_no_newline_root_commands'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'style_not_closed_no_newline_root_commands'};
