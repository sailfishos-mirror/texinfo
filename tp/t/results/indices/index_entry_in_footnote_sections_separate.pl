...
$result_trees{'index_entry_in_footnote_sections_separate'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[0]{'contents'}[2]{'contents'}[1]{'extra'}{'entry_node'} = $result_trees{'index_entry_in_footnote_sections_separate'}{'contents'}[1];
