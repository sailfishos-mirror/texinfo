...
$result_trees{'seeentry'}{'contents'}[4]{'contents'}[1]{'extra'}{'entry_node'} = $result_trees{'seeentry'}{'contents'}[3];
...
$result_trees{'seeentry'}{'contents'}[4]{'contents'}[2]{'extra'}{'entry_node'} = $result_trees{'seeentry'}{'contents'}[3];
...
$result_trees{'seeentry'}{'contents'}[4]{'contents'}[4]{'extra'}{'entry_node'} = $result_trees{'seeentry'}{'contents'}[3];
...
$result_trees{'seeentry'}{'contents'}[4]{'contents'}[5]{'extra'}{'entry_node'} = $result_trees{'seeentry'}{'contents'}[3];
