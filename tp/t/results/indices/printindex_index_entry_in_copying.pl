...
<dt class="deffn defun-alias-deffn" id="index-copying-fun"><span class="category-def">Function: </span><span><code class="def-name">fun</code> <var class="def-meta-var-arguments">arg</var><a class="copiable-link" href=\'#index-copying-fun\'> &para;</a></span></dt>
<dt class="deffnx defunx-alias-deffnx def-cmd-deffn" id="index-copying-xf"><span class="category-def">Function: </span><span><code class="def-name">xf</code> <var class="def-meta-var-arguments">arg</var><a class="copiable-link" href=\'#index-copying-xf\'> &para;</a></span></dt>
<dd><p>Defun
</p></dd></dl>
