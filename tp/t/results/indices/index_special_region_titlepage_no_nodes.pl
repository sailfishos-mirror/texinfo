...
$result_sectioning{'index_special_region_titlepage_no_nodes'}{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'index_special_region_titlepage_no_nodes'};
...
$result_nodes{'index_special_region_titlepage_no_nodes'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'index_special_region_titlepage_no_nodes'};
$result_nodes{'index_special_region_titlepage_no_nodes'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'index_special_region_titlepage_no_nodes'};
$result_nodes{'index_special_region_titlepage_no_nodes'}{'structure'}{'menu_child'} = $result_nodes{'index_special_region_titlepage_no_nodes'}{'extra'}{'node_directions'}{'next'};
...
$result_menus{'index_special_region_titlepage_no_nodes'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'index_special_region_titlepage_no_nodes'};
