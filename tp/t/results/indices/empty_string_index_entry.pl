...
<dt class="deffn defun-alias-deffn" id="index--2"><span class="category">Function: </span><span><strong class="strong"><!-- /@w --></strong> <em class="emph"> </em><a class="copiable-anchor" href=\'#index--2\'> &para;</a></span></dt>
<dt class="deffnx defunx-alias-deffnx def-cmd-deffn" id="index--3"><span class="category">Function: </span><span><strong class="strong"><!-- /@w --></strong> <em class="emph"> </em><a class="copiable-anchor" href=\'#index--3\'> &para;</a></span></dt>
</dl>
