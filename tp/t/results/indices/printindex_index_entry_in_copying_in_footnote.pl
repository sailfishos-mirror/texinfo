...
$result_nodes{'printindex_index_entry_in_copying_in_footnote'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'printindex_index_entry_in_copying_in_footnote'};
$result_nodes{'printindex_index_entry_in_copying_in_footnote'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'printindex_index_entry_in_copying_in_footnote'};
$result_nodes{'printindex_index_entry_in_copying_in_footnote'}{'structure'}{'menu_child'} = $result_nodes{'printindex_index_entry_in_copying_in_footnote'}{'extra'}{'node_directions'}{'next'};
