...
<dl class="def">
<dt id="index-mmm_002dmode"><span class="category">Command: </span><span><strong>mmm-mode</strong> <em><var>arg</var></em><a class="copiable-anchor" href=\'#index-mmm_002dmode\'> &para;</a></span></dt>
<dd><p>Toggle the state of MMM Mode.
</p></dd></dl>

<dl class="def">
<dt id="index-mmm_002dmode-1"><span class="category">Variable: </span><span><strong>mmm-mode</strong><a class="copiable-anchor" href=\'#index-mmm_002dmode-1\'> &para;</a></span></dt>
