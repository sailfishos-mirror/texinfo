...
$result_trees{'same_only_seealso_seeentry'}{'contents'}[4]{'contents'}[3]{'extra'}{'seealso'} = $result_trees{'same_only_seealso_seeentry'}{'contents'}[4]{'contents'}[3]{'args'}[0]{'contents'}[2];
...
$result_trees{'same_only_seealso_seeentry'}{'contents'}[4]{'contents'}[6]{'extra'}{'seeentry'} = $result_trees{'same_only_seealso_seeentry'}{'contents'}[4]{'contents'}[6]{'args'}[0]{'contents'}[2];
...
$result_trees{'same_only_seealso_seeentry'}{'contents'}[4]{'contents'}[8]{'extra'}{'seealso'} = $result_trees{'same_only_seealso_seeentry'}{'contents'}[4]{'contents'}[8]{'args'}[0]{'contents'}[2];
...
$result_trees{'same_only_seealso_seeentry'}{'contents'}[4]{'contents'}[9]{'extra'}{'seeentry'} = $result_trees{'same_only_seealso_seeentry'}{'contents'}[4]{'contents'}[9]{'args'}[0]{'contents'}[2];
