...
$result_trees{'multiple_in_preamble'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'extra'}{'entry_node'} = $result_trees{'multiple_in_preamble'}{'contents'}[3];
...
$result_trees{'multiple_in_preamble'}{'contents'}[4]{'contents'}[5]{'contents'}[0]{'extra'}{'entry_node'} = $result_trees{'multiple_in_preamble'}{'contents'}[3];
