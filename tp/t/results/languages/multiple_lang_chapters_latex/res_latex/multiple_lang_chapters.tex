...
\hangindent=2em
\noindent\texttt{BBB \EmbracOn{}\textnormal{\textsl{CCC}}\EmbracOff{}}& [Instance Variable of \texttt{AAA}]
\end{tabularx}
...
\rightskip=5em plus 1 fill
\hangindent=2em
\noindent\texttt{BBB \EmbracOn{}\textnormal{\textsl{CCC}}\EmbracOff{}}& [Variable d'instance of \texttt{AAA}]
\end{tabularx}
