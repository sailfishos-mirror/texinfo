...
$result_sectioning{'no_monolithic'}{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'no_monolithic'};
...
$result_nodes{'no_monolithic'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'no_monolithic'};
$result_nodes{'no_monolithic'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'no_monolithic'};
$result_nodes{'no_monolithic'}{'structure'}{'menu_child'} = $result_nodes{'no_monolithic'}{'extra'}{'node_directions'}{'next'};
...
$result_menus{'no_monolithic'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'no_monolithic'};
