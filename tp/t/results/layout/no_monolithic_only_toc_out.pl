...
$result_trees{'no_monolithic_only_toc_out'}{'contents'}[2]{'contents'}[4]{'extra'}{'element_node'} = $result_trees{'no_monolithic_only_toc_out'}{'contents'}[1];
$result_trees{'no_monolithic_only_toc_out'}{'contents'}[2]{'contents'}[6]{'contents'}[1]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'no_monolithic_only_toc_out'}{'contents'}[2]{'contents'}[6]{'contents'}[1]{'contents'}[1]{'contents'}[0];
