...
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'args'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1];
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[1]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[1];
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[1]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[2]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[3]{'contents'}[0]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[3]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[3]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[3];
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'args'}[3]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
...
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[0];
...
$result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'extra'}{'end_command'} = $result_trees{'navigation_section_no_header'}{'contents'}[2]{'contents'}[1]{'contents'}[1];
...
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'args'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1];
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[1]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[1];
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[1]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[2]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[3]{'contents'}[0]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[3]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[3]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[3];
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'args'}[3]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[0];
...
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[1]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[1]{'args'}[0];
...
$result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'extra'}{'end_command'} = $result_trees{'navigation_section_no_header'}{'contents'}[4]{'contents'}[1]{'contents'}[1];
...
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'args'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27];
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[1]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[1];
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[1]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[2]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[3]{'contents'}[0]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[3]{'contents'}[0];
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[3]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[3];
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0]{'args'}[3]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[0];
...
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[1]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[1]{'args'}[0];
...
$result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'extra'}{'end_command'} = $result_trees{'navigation_section_no_header'}{'contents'}[6]{'contents'}[27]{'contents'}[1];
