...
$result_trees{'no_titlepage_and_setchapternewpage_on'}{'contents'}[0]{'contents'}[0]{'contents'}[1]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'no_titlepage_and_setchapternewpage_on'}{'contents'}[0]{'contents'}[0]{'contents'}[1]{'args'}[0];
$result_trees{'no_titlepage_and_setchapternewpage_on'}{'contents'}[0]{'contents'}[0]{'contents'}[1]{'args'}[0]{'parent'} = $result_trees{'no_titlepage_and_setchapternewpage_on'}{'contents'}[0]{'contents'}[0]{'contents'}[1];
$result_trees{'no_titlepage_and_setchapternewpage_on'}{'contents'}[0]{'contents'}[0]{'contents'}[1]{'parent'} = $result_trees{'no_titlepage_and_setchapternewpage_on'}{'contents'}[0]{'contents'}[0];
