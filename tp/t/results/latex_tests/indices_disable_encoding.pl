...
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[9]{'extra'}{'subentry'}{'args'}[0]{'contents'}[11] = $result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[9]{'extra'}{'seealso'};
