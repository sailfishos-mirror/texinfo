...
$result_trees{'colons_in_index_entries_and_node'}{'contents'}[1]{'contents'}[1]{'extra'}{'end_command'} = $result_trees{'colons_in_index_entries_and_node'}{'contents'}[1]{'contents'}[1]{'contents'}[2];
...
$result_trees{'colons_in_index_entries_and_node'}{'contents'}[2]{'contents'}[5]{'extra'}{'end_command'} = $result_trees{'colons_in_index_entries_and_node'}{'contents'}[2]{'contents'}[5]{'contents'}[1];
