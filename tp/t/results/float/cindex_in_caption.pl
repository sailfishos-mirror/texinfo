...
$result_trees{'cindex_in_caption'}{'contents'}[2]{'contents'}[3]{'contents'}[1]{'args'}[0]{'contents'}[0]{'contents'}[1]{'extra'}{'entry_node'} = $result_trees{'cindex_in_caption'}{'contents'}[2];
