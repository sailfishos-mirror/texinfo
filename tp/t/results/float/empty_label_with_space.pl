...
$result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'extra'}{'float_type'}{'content'} = $result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[0]{'contents'};
