...
$result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[0]{'parent'} = $result_trees{'empty_label_with_space'}{'contents'}[0];
$result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[0];
$result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[0]{'parent'} = $result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1];
$result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[1]{'contents'}[0]{'extra'}{'command'} = $result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[1];
$result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[1]{'contents'}[0]{'parent'} = $result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[1];
$result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1]{'args'}[1]{'parent'} = $result_trees{'empty_label_with_space'}{'contents'}[0]{'contents'}[1];
