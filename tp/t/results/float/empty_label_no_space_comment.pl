...
$result_trees{'empty_label_no_space_comment'}{'contents'}[0]{'contents'}[1]{'extra'}{'float_type'}{'content'} = $result_trees{'empty_label_no_space_comment'}{'contents'}[0]{'contents'}[1]{'args'}[0]{'contents'};
