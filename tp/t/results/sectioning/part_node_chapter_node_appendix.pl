...
$result_trees{'part_node_chapter_node_appendix'}[1]{'unit_prev'} = $result_trees{'part_node_chapter_node_appendix'}[0];
...
$result_trees{'part_node_chapter_node_appendix'}[2]{'unit_prev'} = $result_trees{'part_node_chapter_node_appendix'}[1];
...
$result_elements{'part_node_chapter_node_appendix'}[0]{'extra'}{'directions'}{'FastForward'}{'extra'}{'directions'}{'FastForward'}{'extra'}{'unit_command'} = $result_elements{'part_node_chapter_node_appendix'}[0]{'extra'}{'directions'}{'FastForward'}{'extra'}{'directions'}{'FastForward'}{'extra'}{'section'};
...
$result_elements{'part_node_chapter_node_appendix'}[0]{'extra'}{'directions'}{'FastForward'}{'extra'}{'unit_command'} = $result_elements{'part_node_chapter_node_appendix'}[0]{'extra'}{'directions'}{'FastForward'}{'extra'}{'section'};
