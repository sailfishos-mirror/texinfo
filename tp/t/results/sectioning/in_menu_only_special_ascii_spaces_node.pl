...
$result_nodes{'in_menu_only_special_ascii_spaces_node'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'in_menu_only_special_ascii_spaces_node'}[0];
