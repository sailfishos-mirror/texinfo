...
$result_trees{'nodes_after_top_before_section_nodes'}[1]{'unit_prev'} = $result_trees{'nodes_after_top_before_section_nodes'}[0];
...
$result_trees{'nodes_after_top_before_section_nodes'}[2]{'unit_prev'} = $result_trees{'nodes_after_top_before_section_nodes'}[1];
