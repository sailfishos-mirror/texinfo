...
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[1]{"extra"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[1]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[1]{"extra"}{"nodes_manuals"}[0]{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[1]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[0]{"extra"}{"menu_entry_description"} = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[0]{"contents"}[3];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[0]{"extra"}{"menu_entry_node_label"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[0]{"contents"}[1]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[1]{"extra"}{"menu_entry_description"} = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[1]{"contents"}[3];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[2]{"extra"}{"menu_entry_description"} = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[2]{"contents"}[3];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[3]{"extra"}{"menu_entry_description"} = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[3]{"contents"}[3];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[3]{"extra"}{"menu_entry_node_label"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[3]{"contents"}[1]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[4]{"extra"}{"menu_entry_description"} = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[4]{"contents"}[3];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[4]{"extra"}{"menu_entry_node_label"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[4]{"contents"}[1]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[5]{"extra"}{"menu_entry_description"} = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[5]{"contents"}[3];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[5]{"extra"}{"menu_entry_node_label"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[2]{"contents"}[1]{"contents"}[5]{"contents"}[1]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[3]{"extra"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[3]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[3]{"extra"}{"nodes_manuals"}[0]{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[3]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[9]{"extra"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[9]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[9]{"extra"}{"nodes_manuals"}[0]{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[9]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[11]{"extra"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[11]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[11]{"extra"}{"nodes_manuals"}[0]{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[11]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[13]{"extra"}{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[13]{"args"}[0]{"contents"}[0];
$result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[13]{"extra"}{"nodes_manuals"}[0]{"node_content"}[0] = $result_trees{'in_menu_only_special_spaces_node_menu'}{"contents"}[13]{"args"}[0]{"contents"}[0];
