...
$result_nodes{'nodes_after_top_before_section_texi2html_chapter'}{'structure'}{'menu_child'} = $result_nodes{'nodes_after_top_before_section_texi2html_chapter'}{'extra'}{'node_directions'}{'next'};
...
$result_menus{'nodes_after_top_before_section_texi2html_chapter'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'next'}{'extra'}{'menu_directions'}{'prev'} = $result_menus{'nodes_after_top_before_section_texi2html_chapter'}{'structure'}{'menu_child'};
$result_menus{'nodes_after_top_before_section_texi2html_chapter'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'next'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'nodes_after_top_before_section_texi2html_chapter'};
$result_menus{'nodes_after_top_before_section_texi2html_chapter'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'nodes_after_top_before_section_texi2html_chapter'};
