...
$result_sectioning{'nodes_after_top_before_section_texi2html_chapter'}{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'nodes_after_top_before_section_texi2html_chapter'};
