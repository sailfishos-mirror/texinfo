...
$result_nodes{'nodes_after_top_before_chapter_not_split_no_use_node_directions'}{'structure'}{'menu_child'} = $result_nodes{'nodes_after_top_before_chapter_not_split_no_use_node_directions'}{'extra'}{'node_directions'}{'next'};
...
$result_menus{'nodes_after_top_before_chapter_not_split_no_use_node_directions'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'next'}{'extra'}{'menu_directions'}{'prev'} = $result_menus{'nodes_after_top_before_chapter_not_split_no_use_node_directions'}{'structure'}{'menu_child'};
$result_menus{'nodes_after_top_before_chapter_not_split_no_use_node_directions'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'next'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'nodes_after_top_before_chapter_not_split_no_use_node_directions'};
$result_menus{'nodes_after_top_before_chapter_not_split_no_use_node_directions'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'nodes_after_top_before_chapter_not_split_no_use_node_directions'};
