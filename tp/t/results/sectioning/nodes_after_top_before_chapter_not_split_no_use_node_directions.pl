...
$result_sectioning{'nodes_after_top_before_chapter_not_split_no_use_node_directions'}{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'nodes_after_top_before_chapter_not_split_no_use_node_directions'};
