...
$result_trees{'top_without_node_nodes'}[0]{'unit_command'}{'contents'}[0]{'contents'}[3]{'extra'}{'manual_content'}{'contents'}[0] = $result_trees{'top_without_node_nodes'}[0]{'unit_command'}{'contents'}[0]{'contents'}[3]{'contents'}[1];
