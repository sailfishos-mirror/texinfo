...
$result_trees{'top_node_up_url'}[1]{'structure'}{'unit_prev'} = $result_trees{'top_node_up_url'}[0];
...
$result_nodes{'top_node_up_url'}{'structure'}{'menu_child'}{'structure'}{'node_prev'} = $result_nodes{'top_node_up_url'};
$result_nodes{'top_node_up_url'}{'structure'}{'menu_child'}{'structure'}{'node_up'} = $result_nodes{'top_node_up_url'};
$result_nodes{'top_node_up_url'}{'structure'}{'node_next'} = $result_nodes{'top_node_up_url'}{'structure'}{'menu_child'};
...
$result_menus{'top_node_up_url'}{'structure'}{'menu_child'}{'structure'}{'menu_up'} = $result_menus{'top_node_up_url'};
...
$result_elements{'top_node_up_url'}[0]{'structure'}{'directions'}{'Forward'}{'extra'}{'node'} = $result_elements{'top_node_up_url'}[0]{'extra'}{'node'}{'structure'}{'menu_child'};
$result_elements{'top_node_up_url'}[0]{'structure'}{'directions'}{'Forward'}{'extra'}{'unit_command'} = $result_elements{'top_node_up_url'}[0]{'extra'}{'node'}{'structure'}{'menu_child'};
