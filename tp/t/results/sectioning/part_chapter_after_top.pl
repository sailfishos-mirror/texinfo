...
$result_trees{'part_chapter_after_top'}[1]{'unit_prev'} = $result_trees{'part_chapter_after_top'}[0];
...
$result_elements{'part_chapter_after_top'}[0]{'extra'}{'directions'}{'FastForward'}{'extra'}{'unit_command'} = $result_elements{'part_chapter_after_top'}[0]{'extra'}{'directions'}{'FastForward'}{'extra'}{'section'};
