...
$result_trees{'non_automatic_internal_top_node_up'}[0]{'contents'}[1]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'non_automatic_internal_top_node_up'}[0]{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'non_automatic_internal_top_node_up'}[1]{'contents'}[0]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'non_automatic_internal_top_node_up'}[1]{'contents'}[0]{'args'}[0]{'contents'}[0];
...
$result_trees{'non_automatic_internal_top_node_up'}[1]{'structure'}{'unit_prev'} = $result_trees{'non_automatic_internal_top_node_up'}[0];
...
$result_nodes{'non_automatic_internal_top_node_up'}{'structure'}{'menu_child'}{'structure'}{'node_prev'} = $result_nodes{'non_automatic_internal_top_node_up'};
$result_nodes{'non_automatic_internal_top_node_up'}{'structure'}{'node_next'} = $result_nodes{'non_automatic_internal_top_node_up'}{'structure'}{'menu_child'};
...
$result_menus{'non_automatic_internal_top_node_up'}{'structure'}{'menu_child'}{'structure'}{'menu_up'} = $result_menus{'non_automatic_internal_top_node_up'};
...
$result_elements{'non_automatic_internal_top_node_up'}[0]{'structure'}{'directions'}{'Forward'}{'extra'}{'node'} = $result_elements{'non_automatic_internal_top_node_up'}[0]{'extra'}{'node'}{'structure'}{'menu_child'};
$result_elements{'non_automatic_internal_top_node_up'}[0]{'structure'}{'directions'}{'Forward'}{'extra'}{'unit_command'} = $result_elements{'non_automatic_internal_top_node_up'}[0]{'extra'}{'node'}{'structure'}{'menu_child'};
