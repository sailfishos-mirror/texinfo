...
$result_trees{'part_node_part_appendix'}[1]{'unit_prev'} = $result_trees{'part_node_part_appendix'}[0];
...
$result_trees{'part_node_part_appendix'}[2]{'unit_prev'} = $result_trees{'part_node_part_appendix'}[1];
