...
$result_elements{'part_node_part_appendix'}[0]{'extra'}{'node'}{'menu_child'}{'menu_up'} = $result_elements{'part_node_part_appendix'}[0]{'extra'}{'node'};
$result_elements{'part_node_part_appendix'}[0]{'extra'}{'unit_command'} = $result_elements{'part_node_part_appendix'}[0]{'extra'}{'section'};
$result_elements{'part_node_part_appendix'}[0]{'structure'}{'directions'}{'FastForward'}{'extra'}{'node'} = $result_elements{'part_node_part_appendix'}[0]{'extra'}{'node'}{'menu_child'};
