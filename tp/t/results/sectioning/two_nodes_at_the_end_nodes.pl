...
$result_sectioning{'two_nodes_at_the_end_nodes'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'two_nodes_at_the_end_nodes'}{'extra'}{'section_childs'}[0];
$result_sectioning{'two_nodes_at_the_end_nodes'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_prev'} = $result_sectioning{'two_nodes_at_the_end_nodes'}{'extra'}{'section_childs'}[0];
$result_sectioning{'two_nodes_at_the_end_nodes'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_up'} = $result_sectioning{'two_nodes_at_the_end_nodes'}{'extra'}{'section_childs'}[0];
$result_sectioning{'two_nodes_at_the_end_nodes'}{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'two_nodes_at_the_end_nodes'};
