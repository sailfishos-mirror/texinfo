...
$result_elements{'part_node_chapter_after_top'}[0]{'extra'}{'node'}{'menu_child'}{'menu_next'}{'menu_prev'} = $result_elements{'part_node_chapter_after_top'}[0]{'extra'}{'node'}{'menu_child'};
$result_elements{'part_node_chapter_after_top'}[0]{'extra'}{'node'}{'menu_child'}{'menu_next'}{'menu_up'} = $result_elements{'part_node_chapter_after_top'}[0]{'extra'}{'node'};
$result_elements{'part_node_chapter_after_top'}[0]{'extra'}{'node'}{'menu_child'}{'menu_up'} = $result_elements{'part_node_chapter_after_top'}[0]{'extra'}{'node'};
...
$result_elements{'part_node_chapter_after_top'}[0]{'structure'}{'directions'}{'FastForward'}{'extra'}{'node'} = $result_elements{'part_node_chapter_after_top'}[0]{'extra'}{'node'}{'menu_child'}{'menu_next'};
