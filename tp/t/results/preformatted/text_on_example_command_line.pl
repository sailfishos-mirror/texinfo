...
$result_trees{'text_on_example_command_line'}{'contents'}[0]{'contents'}[4]{'extra'}{'end_command'} = $result_trees{'text_on_example_command_line'}{'contents'}[0]{'contents'}[4]{'contents'}[1];
...
$result_trees{'text_on_example_command_line'}{'contents'}[0]{'contents'}[6]{'contents'}[0]{'extra'}{'end_command'} = $result_trees{'text_on_example_command_line'}{'contents'}[0]{'contents'}[6]{'contents'}[0]{'contents'}[0];
...
$result_trees{'text_on_example_command_line'}{'contents'}[0]{'contents'}[6]{'extra'}{'end_command'} = $result_trees{'text_on_example_command_line'}{'contents'}[0]{'contents'}[6]{'contents'}[1];
