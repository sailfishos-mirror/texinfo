...
$result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[0]{'extra'}{'command'} = $result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5];
...
$result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[2]{'contents'}[0]{'parent'} = $result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[2];
...
$result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[3]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[3]{'args'}[0];
$result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[3]{'args'}[0]{'parent'} = $result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[3];
$result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[3]{'parent'} = $result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5];
$result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'extra'}{'end_command'} = $result_trees{'paragraph_indent_asis'}{'contents'}[0]{'contents'}[5]{'contents'}[3];
