...
$result_sectioning{'footnote_no_number_separate'}{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'footnote_no_number_separate'};
...
$result_nodes{'footnote_no_number_separate'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'footnote_no_number_separate'};
$result_nodes{'footnote_no_number_separate'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'footnote_no_number_separate'};
