...
$result_sectioning{'contents_at_document_begin_separate_element'}{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'contents_at_document_begin_separate_element'};
