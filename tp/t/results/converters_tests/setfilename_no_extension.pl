...
$result_trees{'setfilename_no_extension'}{'contents'}[1]{'extra'}{'node_content'}[0] = $result_trees{'setfilename_no_extension'}{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'setfilename_no_extension'}{'contents'}[3]{'extra'}{'node_content'}[0] = $result_trees{'setfilename_no_extension'}{'contents'}[3]{'args'}[0]{'contents'}[0];
