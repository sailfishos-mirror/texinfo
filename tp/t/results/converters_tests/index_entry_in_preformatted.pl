...
$result_trees{'index_entry_in_preformatted'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'contents'}[0]{'extra'}{'entry_node'} = $result_trees{'index_entry_in_preformatted'}{'contents'}[3];
...
$result_trees{'index_entry_in_preformatted'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'contents'}[3]{'extra'}{'entry_node'} = $result_trees{'index_entry_in_preformatted'}{'contents'}[3];
...
$result_trees{'index_entry_in_preformatted'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'contents'}[5]{'extra'}{'entry_node'} = $result_trees{'index_entry_in_preformatted'}{'contents'}[3];
