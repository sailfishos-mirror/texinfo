...
$result_trees{'non_empty_part'}{'contents'}[1]{'extra'}{'node_content'}[0] = $result_trees{'non_empty_part'}{'contents'}[1]{'args'}[0]{'contents'}[0];
$result_trees{'non_empty_part'}{'contents'}[1]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'non_empty_part'}{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'extra'}{'command'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[1]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[1]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[2]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3]{'contents'}[0]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3]{'contents'}[0];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'extra'}{'menu_entry_description'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'extra'}{'menu_entry_node'}{'node_content'}[0] = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[1]{'contents'}[0];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[1]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[1]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[2]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[3]{'contents'}[0]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[3]{'contents'}[0];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[3]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[3];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[3]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'extra'}{'menu_entry_description'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[3];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'extra'}{'menu_entry_node'}{'node_content'}[0] = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'args'}[1]{'contents'}[0];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[2]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[3]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[3]{'args'}[0];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[3]{'args'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[3];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[3]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'extra'}{'end_command'} = $result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'contents'}[3];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[1]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2];
$result_trees{'non_empty_part'}{'contents'}[2]{'contents'}[2]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[2];
...
$result_trees{'non_empty_part'}{'contents'}[4]{'extra'}{'associated_part'} = $result_trees{'non_empty_part'}{'contents'}[3];
...
$result_trees{'non_empty_part'}{'contents'}[5]{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[5]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[5]{'contents'}[1]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[5];
$result_trees{'non_empty_part'}{'contents'}[5]{'contents'}[2]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[5];
...
$result_trees{'non_empty_part'}{'contents'}[6]{'extra'}{'node_content'}[0] = $result_trees{'non_empty_part'}{'contents'}[6]{'args'}[0]{'contents'}[0];
$result_trees{'non_empty_part'}{'contents'}[6]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'non_empty_part'}{'contents'}[6]{'args'}[0]{'contents'}[0];
...
$result_trees{'non_empty_part'}{'contents'}[7]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[7];
$result_trees{'non_empty_part'}{'contents'}[7]{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[7]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[7]{'contents'}[1]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[7];
$result_trees{'non_empty_part'}{'contents'}[7]{'contents'}[2]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[7];
...
$result_trees{'non_empty_part'}{'contents'}[8]{'extra'}{'associated_part'} = $result_trees{'non_empty_part'}{'contents'}[7];
...
$result_trees{'non_empty_part'}{'contents'}[9]{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[9]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[9]{'contents'}[1]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[9];
$result_trees{'non_empty_part'}{'contents'}[9]{'contents'}[2]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[9];
...
$result_trees{'non_empty_part'}{'contents'}[11]{'extra'}{'associated_part'} = $result_trees{'non_empty_part'}{'contents'}[10];
...
$result_trees{'non_empty_part'}{'contents'}[12]{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[12]{'contents'}[1];
$result_trees{'non_empty_part'}{'contents'}[12]{'contents'}[1]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[12];
$result_trees{'non_empty_part'}{'contents'}[12]{'contents'}[2]{'parent'} = $result_trees{'non_empty_part'}{'contents'}[12];
...
$result_trees{'non_empty_part'}{'contents'}[13]{'extra'}{'node_content'}[0] = $result_trees{'non_empty_part'}{'contents'}[13]{'args'}[0]{'contents'}[0];
$result_trees{'non_empty_part'}{'contents'}[13]{'extra'}{'nodes_manuals'}[0]{'node_content'}[0] = $result_trees{'non_empty_part'}{'contents'}[13]{'args'}[0]{'contents'}[0];
...
$result_trees{'non_empty_part'}{'contents'}[14]{'extra'}{'associated_part'} = $result_trees{'non_empty_part'}{'contents'}[12];
...
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'extra'}{'part_associated_section'}{'extra'}{'associated_part'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'extra'}{'part_associated_section'}{'structure'}{'section_up'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'extra'}{'part_associated_section'}{'structure'}{'toplevel_prev'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[0];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'extra'}{'part_associated_section'}{'structure'}{'toplevel_up'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[0];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'structure'}{'section_childs'}[0] = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'extra'}{'part_associated_section'};
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'structure'}{'section_prev'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[0];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'structure'}{'section_up'} = $result_sectioning{'non_empty_part'};
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[2]{'structure'}{'section_prev'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[2]{'structure'}{'section_up'} = $result_sectioning{'non_empty_part'};
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3]{'extra'}{'part_associated_section'}{'extra'}{'associated_part'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3]{'extra'}{'part_associated_section'}{'structure'}{'section_up'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3]{'extra'}{'part_associated_section'}{'structure'}{'toplevel_prev'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[1]{'extra'}{'part_associated_section'};
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3]{'extra'}{'part_associated_section'}{'structure'}{'toplevel_up'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[0];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3]{'structure'}{'section_childs'}[0] = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3]{'extra'}{'part_associated_section'};
...
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5]{'extra'}{'part_associated_section'}{'extra'}{'associated_part'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5]{'extra'}{'part_associated_section'}{'structure'}{'section_up'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5]{'extra'}{'part_associated_section'}{'structure'}{'toplevel_prev'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[3]{'extra'}{'part_associated_section'};
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5]{'extra'}{'part_associated_section'}{'structure'}{'toplevel_up'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[0];
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5]{'structure'}{'section_childs'}[0] = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5]{'extra'}{'part_associated_section'};
...
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[6]{'extra'}{'part_associated_section'}{'structure'}{'toplevel_prev'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[5]{'extra'}{'part_associated_section'};
$result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[6]{'extra'}{'part_associated_section'}{'structure'}{'toplevel_up'} = $result_sectioning{'non_empty_part'}{'structure'}{'section_childs'}[0];
...
$result_converted{'html_text'}->{'non_empty_part'} = '<div class="top-level-extent" id="Top">
<div class="nav-panel">
<p>
 &nbsp; </p>
</div>
...
$result_converted{'xml'}->{'non_empty_part'} = '<node name="Top" spaces=" "><nodename>Top</nodename><nodenext automatic="on">part chapter node</nodenext></node>
...
Tag Table:
Node: Top27
Node: part chapter node207
Node: node between part and chapter405

End Tag Table
