...
$result_trees{'form_feeds'}{'contents'}[2]{'contents'}[27]{'contents'}[0]{'extra'}{'entry_node'} = $result_trees{'form_feeds'}{'contents'}[2];
...
$result_trees{'form_feeds'}{'contents'}[2]{'contents'}[27]{'contents'}[1]{'extra'}{'entry_node'} = $result_trees{'form_feeds'}{'contents'}[2];
