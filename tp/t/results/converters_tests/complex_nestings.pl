...
</pre></dd><dt class="defvrx defvarx-alias-defvrx def-cmd-defvr" id="index-variables-too"><span class="category">Variable: </span><span><strong class="strong">variables too</strong> <em class="emph">other-variable</em><a class="copiable-anchor" href=\'#index-variables-too\'> &para;</a></span></dt>
