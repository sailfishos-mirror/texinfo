...
<dt class="deffn defun-alias-deffn" id="index-my-def"><span class="category-def">Function: </span><span><code class="code">my def</code> <span class="r"><i class="slanted">args <var class="var">arg</var> &hellip;</i></span><a class="copiable-link" href=\'#index-my-def\'> &para;</a></span></dt>
<dt class="deffnx defunx-alias-deffnx def-cmd-deffn" id="index-other-def"><span class="category-def">Function: </span><span><code class="code">other def</code> <span class="r"><i class="slanted">no args</i></span><a class="copiable-link" href=\'#index-other-def\'> &para;</a></span></dt>
<dd><dl class="first-deffn">
<dt class="deffn" id="index-name"><span class="category-def">type: </span><span><code class="code">name</code> <span class="r"><i class="slanted">and now the args</i></span><a class="copiable-link" href=\'#index-name\'> &para;</a></span></dt>
<dd><dl class="first-defvr first-defvar-alias-first-defvr">
<dt class="defvr defvar-alias-defvr" id="index-variables"><span class="category-def">Variable: </span><span><code class="code">variables</code> <span class="r"><i class="slanted">variable-name</i></span><a class="copiable-link" href=\'#index-variables\'> &para;</a></span></dt>
<dd><pre class="example-preformatted">

</pre></dd><dt class="defvrx defvarx-alias-defvrx def-cmd-defvr" id="index-variables-too"><span class="category-def">Variable: </span><span><code class="code">variables too</code> <span class="r"><i class="slanted">other-variable</i></span><a class="copiable-link" href=\'#index-variables-too\'> &para;</a></span></dt>
