...
$result_nodes{'no_content_do_contents_separate_element'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'no_content_do_contents_separate_element'};
$result_nodes{'no_content_do_contents_separate_element'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'no_content_do_contents_separate_element'};
$result_nodes{'no_content_do_contents_separate_element'}{'structure'}{'menu_child'} = $result_nodes{'no_content_do_contents_separate_element'}{'extra'}{'node_directions'}{'next'};
