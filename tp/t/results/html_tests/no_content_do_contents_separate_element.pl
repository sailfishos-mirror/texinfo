...
$result_trees{'no_content_do_contents_separate_element'}{'contents'}[1]{'extra'}{'node_content'}[0] = $result_trees{'no_content_do_contents_separate_element'}{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'no_content_do_contents_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'extra'}{'menu_entry_description'} = $result_trees{'no_content_do_contents_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[3];
$result_trees{'no_content_do_contents_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'extra'}{'menu_entry_node'}{'node_content'}[0] = $result_trees{'no_content_do_contents_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'contents'}[0];
$result_trees{'no_content_do_contents_separate_element'}{'contents'}[3]{'extra'}{'node_content'}[0] = $result_trees{'no_content_do_contents_separate_element'}{'contents'}[3]{'args'}[0]{'contents'}[0];
