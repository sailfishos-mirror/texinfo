...
$result_menus{'contents_in_middle_chapter_separate_element'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'contents_in_middle_chapter_separate_element'};
$result_menus{'contents_in_middle_chapter_separate_element'}{'structure'}{'menu_child'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'contents_in_middle_chapter_separate_element'}{'structure'}{'menu_child'};
