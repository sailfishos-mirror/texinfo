...
$result_nodes{'contents_in_middle_chapter_separate_element'}{'extra'}{'node_directions'}{'next'}{'structure'}{'menu_child'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'contents_in_middle_chapter_separate_element'}{'extra'}{'node_directions'}{'next'};
$result_nodes{'contents_in_middle_chapter_separate_element'}{'structure'}{'menu_child'} = $result_nodes{'contents_in_middle_chapter_separate_element'}{'extra'}{'node_directions'}{'next'};
