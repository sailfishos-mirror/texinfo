...
$result_trees{'contents_in_middle_chapter_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'contents_in_middle_chapter_separate_element'}{'contents'}[2]{'contents'}[3]{'contents'}[0]{'contents'}[1]{'contents'}[0];
$result_trees{'contents_in_middle_chapter_separate_element'}{'contents'}[4]{'contents'}[4]{'contents'}[0]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'contents_in_middle_chapter_separate_element'}{'contents'}[4]{'contents'}[4]{'contents'}[0]{'contents'}[1]{'contents'}[0];
...
$result_nodes{'contents_in_middle_chapter_separate_element'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'contents_in_middle_chapter_separate_element'}[0];
$result_nodes{'contents_in_middle_chapter_separate_element'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'contents_in_middle_chapter_separate_element'}[0];
$result_nodes{'contents_in_middle_chapter_separate_element'}[1] = $result_nodes{'contents_in_middle_chapter_separate_element'}[0]{'extra'}{'node_directions'}{'next'};
$result_nodes{'contents_in_middle_chapter_separate_element'}[2]{'extra'}{'node_directions'}{'up'} = $result_nodes{'contents_in_middle_chapter_separate_element'}[0]{'extra'}{'node_directions'}{'next'};
