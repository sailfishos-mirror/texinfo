...
$result_trees{'top_node_up_explicit_no_nodes'}{'contents'}[1]{'contents'}[0]{'contents'}[1]{'extra'}{'manual_content'}{'contents'}[0] = $result_trees{'top_node_up_explicit_no_nodes'}{'contents'}[1]{'contents'}[0]{'contents'}[1]{'contents'}[1];
$result_trees{'top_node_up_explicit_no_nodes'}{'contents'}[1]{'contents'}[0]{'contents'}[2]{'extra'}{'manual_content'}{'contents'}[0] = $result_trees{'top_node_up_explicit_no_nodes'}{'contents'}[1]{'contents'}[0]{'contents'}[2]{'contents'}[1];
$result_trees{'top_node_up_explicit_no_nodes'}{'contents'}[1]{'contents'}[0]{'contents'}[3]{'extra'}{'manual_content'}{'contents'}[0] = $result_trees{'top_node_up_explicit_no_nodes'}{'contents'}[1]{'contents'}[0]{'contents'}[3]{'contents'}[1];
$result_trees{'top_node_up_explicit_no_nodes'}{'contents'}[2]{'contents'}[4]{'contents'}[1]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'top_node_up_explicit_no_nodes'}{'contents'}[2]{'contents'}[4]{'contents'}[1]{'contents'}[1]{'contents'}[0];
