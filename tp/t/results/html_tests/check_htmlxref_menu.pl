...
$result_sectioning{'check_htmlxref_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'check_htmlxref_menu'}{'extra'}{'section_childs'}[0];
$result_sectioning{'check_htmlxref_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_prev'} = $result_sectioning{'check_htmlxref_menu'}{'extra'}{'section_childs'}[0];
$result_sectioning{'check_htmlxref_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_up'} = $result_sectioning{'check_htmlxref_menu'}{'extra'}{'section_childs'}[0];
$result_sectioning{'check_htmlxref_menu'}{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'check_htmlxref_menu'};
