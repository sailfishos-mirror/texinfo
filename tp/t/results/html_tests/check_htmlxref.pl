...
$result_sectioning{'check_htmlxref'}{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'check_htmlxref'};
...
$result_nodes{'check_htmlxref'}{'structure'}{'menu_child'} = $result_nodes{'check_htmlxref'}{'extra'}{'node_directions'}{'prev'};
...
$result_menus{'check_htmlxref'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'check_htmlxref'};
