...
$result_sectioning{'no_content_do_contents_inline'}{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'no_content_do_contents_inline'};
...
$result_nodes{'no_content_do_contents_inline'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'no_content_do_contents_inline'};
$result_nodes{'no_content_do_contents_inline'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'no_content_do_contents_inline'};
$result_nodes{'no_content_do_contents_inline'}{'structure'}{'menu_child'} = $result_nodes{'no_content_do_contents_inline'}{'extra'}{'node_directions'}{'next'};
...
$result_menus{'no_content_do_contents_inline'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'no_content_do_contents_inline'};
