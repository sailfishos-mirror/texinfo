...
$result_sectioning{'no_content_do_contents_inline'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'no_content_do_contents_inline'}{'extra'}{'section_childs'}[0];
$result_sectioning{'no_content_do_contents_inline'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_prev'} = $result_sectioning{'no_content_do_contents_inline'}{'extra'}{'section_childs'}[0];
$result_sectioning{'no_content_do_contents_inline'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_up'} = $result_sectioning{'no_content_do_contents_inline'}{'extra'}{'section_childs'}[0];
$result_sectioning{'no_content_do_contents_inline'}{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'no_content_do_contents_inline'};
