...
$result_nodes{'check_htmlxref_ignore_ref_top_up'}{'structure'}{'menu_child'} = $result_nodes{'check_htmlxref_ignore_ref_top_up'}{'extra'}{'node_directions'}{'prev'};
...
$result_menus{'check_htmlxref_ignore_ref_top_up'}{'structure'}{'menu_child'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'check_htmlxref_ignore_ref_top_up'};
