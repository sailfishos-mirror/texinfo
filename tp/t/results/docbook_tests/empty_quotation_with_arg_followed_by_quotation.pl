...
$result_trees{'empty_quotation_with_arg_followed_by_quotation'}{'contents'}[0]{'contents'}[2]{'extra'}{'end_command'} = $result_trees{'empty_quotation_with_arg_followed_by_quotation'}{'contents'}[0]{'contents'}[2]{'contents'}[1];
