...
$result_sectioning{'index_entries_relate_to_item_no_transformation'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'index_entries_relate_to_item_no_transformation'}{'extra'}{'section_childs'}[0];
$result_sectioning{'index_entries_relate_to_item_no_transformation'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_prev'} = $result_sectioning{'index_entries_relate_to_item_no_transformation'}{'extra'}{'section_childs'}[0];
$result_sectioning{'index_entries_relate_to_item_no_transformation'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'structure'}{'toplevel_up'} = $result_sectioning{'index_entries_relate_to_item_no_transformation'}{'extra'}{'section_childs'}[0];
$result_sectioning{'index_entries_relate_to_item_no_transformation'}{'extra'}{'section_childs'}[0]{'structure'}{'section_up'} = $result_sectioning{'index_entries_relate_to_item_no_transformation'};
