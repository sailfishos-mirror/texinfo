...
$result_trees{'noindent_indent'}{'contents'}[0]{'contents'}[2]{'extra'}{'spaces_associated_command'} = $result_trees{'noindent_indent'}{'contents'}[0]{'contents'}[1];
...
$result_trees{'noindent_indent'}{'contents'}[0]{'contents'}[6]{'extra'}{'spaces_associated_command'} = $result_trees{'noindent_indent'}{'contents'}[0]{'contents'}[5];
