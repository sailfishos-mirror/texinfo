...
$result_errors{'test_allowcodebreaks'} = [
  {
    'error_line' => 'warning: @code should not appear in @w (possibly involving @testallowcodebreakspara)
',
    'file_name' => '',
    'line_nr' => 29,
    'macro' => 'testallowcodebreakspara',
...
',
  ...
  {
    'error_line' => 'warning: @samp should not appear in @w (possibly involving @testallowcodebreakspara)
',
    'file_name' => '',
    'line_nr' => 29,
    'macro' => 'testallowcodebreakspara',
