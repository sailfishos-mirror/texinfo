...
$result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[1]{'extra'}{'node_content'}[0] = $result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[1]{'contents'}[0];
$result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[2]{'extra'}{'node_content'}[0] = $result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[2]{'contents'}[0];
$result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[2]{'extra'}{'node_content'}[1] = $result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[2]{'contents'}[1];
$result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[3]{'extra'}{'node_content'}[0] = $result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[3]{'contents'}[0];
$result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[3]{'extra'}{'node_content'}[1] = $result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_command'}{'args'}[3]{'contents'}[1];
...
$result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_contents'}[2]{'contents'}[1]{'contents'}[0]{'contents'}[1]{'extra'}{'node_content'}[0] = $result_trees{'non_automatic_internal_top_node_up'}[0]{'unit_contents'}[2]{'contents'}[1]{'contents'}[0]{'contents'}[1]{'contents'}[0];
$result_trees{'non_automatic_internal_top_node_up'}[1]{'unit_command'}{'args'}[2]{'extra'}{'node_content'}[0] = $result_trees{'non_automatic_internal_top_node_up'}[1]{'unit_command'}{'args'}[2]{'contents'}[0];
$result_trees{'non_automatic_internal_top_node_up'}[1]{'unit_command'}{'args'}[3]{'extra'}{'node_content'}[0] = $result_trees{'non_automatic_internal_top_node_up'}[1]{'unit_command'}{'args'}[3]{'contents'}[0];
$result_trees{'non_automatic_internal_top_node_up'}[1]{'unit_command'}{'args'}[3]{'extra'}{'node_content'}[1] = $result_trees{'non_automatic_internal_top_node_up'}[1]{'unit_command'}{'args'}[3]{'contents'}[1];
