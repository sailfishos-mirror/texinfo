...
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'Back'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'FastBack'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'NodeBack'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'NodePrev'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'This'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'tree_unit_directions'}{'prev'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'unit_command'}{'associated_unit'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'unit_command'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'non_automatic_internal_top_node_up'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'NodeForward'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'NodeNext'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'This'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'tree_unit_directions'}{'next'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'unit_command'} = $result_nodes{'non_automatic_internal_top_node_up'};
$result_nodes{'non_automatic_internal_top_node_up'}{'extra'}{'associated_section'}{'associated_unit'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_nodes{'non_automatic_internal_top_node_up'}{'extra'}{'node_directions'}{'next'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'unit_command'};
$result_nodes{'non_automatic_internal_top_node_up'}{'structure'}{'menu_child'} = $result_nodes{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'unit_command'};
...
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'Back'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'FastBack'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'NodeBack'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'NodePrev'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'directions'}{'This'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'tree_unit_directions'}{'prev'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'unit_command'}{'associated_unit'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'unit_command'}{'extra'}{'menu_directions'}{'up'} = $result_menus{'non_automatic_internal_top_node_up'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'NodeForward'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'NodeNext'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'This'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'tree_unit_directions'}{'next'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'};
$result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'unit_command'} = $result_menus{'non_automatic_internal_top_node_up'};
$result_menus{'non_automatic_internal_top_node_up'}{'structure'}{'menu_child'} = $result_menus{'non_automatic_internal_top_node_up'}{'associated_unit'}{'directions'}{'Forward'}{'unit_command'};
