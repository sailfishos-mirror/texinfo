...
$result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'extra'}{'menu_entry_description'} = $result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'args'}[5];
$result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'extra'}{'menu_entry_name'} = $result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'args'}[1];
$result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'extra'}{'menu_entry_node'}{'manual_content'}[0] = $result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'args'}[3]{'contents'}[1];
$result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[1]{'extra'}{'menu_entry_description'} = $result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[1]{'args'}[5];
$result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[1]{'extra'}{'menu_entry_name'} = $result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[1]{'args'}[1];
$result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[1]{'extra'}{'menu_entry_node'}{'manual_content'}[0] = $result_trees{'formatting_fr'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[1]{'args'}[3]{'contents'}[1];
...
$result_texts{'formatting_fr'} = '* Truc: (formatting).           The GNU documentation truc.
...
$result_converted{'info'}->{'formatting_fr'} = 'This is , produced from formatting.texi.
...

File: ,  Node: subsubsection ``simple-double--,  Next: subsubsection three---four----\'\',  Up: subsection

1.1.1.1 subsubsection “simple-double–
.....................................


File: ,  Node: subsubsection three---four----\'\',  Prev: subsubsection ``simple-double--,  Up: subsection
...
Node: Top295
Node: chapter1362
Ref: chapter-Footnote-11581
Node: s--ect,ion1601
Node: subsection1789
Ref: anchor1955
