...
$result_trees{'space_in_def_for_index'}{'contents'}[2]{'contents'}[1]{'contents'}[0]{'extra'}{'entry_node'} = $result_trees{'space_in_def_for_index'}{'contents'}[2];
...
$result_trees{'space_in_def_for_index'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'extra'}{'entry_node'} = $result_trees{'space_in_def_for_index'}{'contents'}[2];
