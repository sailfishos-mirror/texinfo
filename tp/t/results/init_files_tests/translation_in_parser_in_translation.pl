...
$result_trees{'translation_in_parser_in_translation'}{'contents'}[4]{'contents'}[2]{'contents'}[0]{'extra'}{'element_node'} = $result_trees{'translation_in_parser_in_translation'}{'contents'}[3];
