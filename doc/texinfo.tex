...
%
\def\texinfoversion{2025-02-18.21}
%
...
\def\anchor#1{%
  \bgroup\def\currentsection{#1}%
    \savesf \setref{#1}{Yanchor}\restoresf \ignorespaces
  \egroup
}
...
\def\donamedanchor#1,#2\finish{%
  \bgroup\def\currentsection{\ignorespaces #2\unskip}%
    \savesf \setref{#1}{Yanchor}\restoresf \ignorespaces
  \egroup
}
