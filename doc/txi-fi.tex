...
%
%\gdef\putwordNext{Seuraava} %ei välttämättä toimi
...
\gdef\putwordSee{Katso}
\gdef\putwordShortTOC{Lyhyt sisällysluettelo}
\gdef\putwordTOC{Sisällysluettelo}
%%
...
\gdef\putwordMJun{Kesäkuu}
\gdef\putwordMJul{Heinäkuu}
...
%%
\gdef\putwordIndexNonexistent{(Indexiä ei ole olemassa)}
\gdef\putwordIndexIsEmpty{(Index on tyhjä)}
%%
%% \defmac
...
%% \defopt
\gdef\putwordDefopt{käyttäjävaihtoehto}
%% \deftypevar
