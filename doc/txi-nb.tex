% txi-nb.tex -- Norwegian translations for texinfo.tex (1999-10-29, GNU
% Texinfo 4.0).
%
% Copyright (C) 1999, 2007, 2008, 2026 Trond Endrestøl <endrestol@hotmail.com>
%
...
% Make Æ Ø Å output in that order.  The characters are sorted by
% texindex according to the first argument to \idxsort but
% printed according to the second.

\DefineSortKey{00C6}{{\string\idxsort{1}{\string\AE{}}}} % Æ
\DefineSortKey{00E6}{{\string\idxsort{1}{\string\AE{}}}} % æ
\DefineSortKey{00D8}{{\string\idxsort{2}{\string\O{}}}} % Ø
\DefineSortKey{00F8}{{\string\idxsort{2}{\string\O{}}}} % ø
\DefineSortKey{00C5}{{\string\idxsort{3}{\string\AA{}}}} % Å
\DefineSortKey{00E5}{{\string\idxsort{3}{\string\AA{}}}} % å
