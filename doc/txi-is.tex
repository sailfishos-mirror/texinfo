...
% 2005/03/30).
%
% Copyright (C) 2009, 2026 Arni Magnusson
%
...
% Make Þ Æ Ö output in that order.  The characters are sorted by
% texindex according to the first argument to \idxsort but
% printed according to the second.

\DefineSortKey{00FE}{{\string\idxsort{1}{\string\TH{}}}} % Þ
\DefineSortKey{00DE}{{\string\idxsort{1}{\string\TH{}}}} % Þ
\DefineSortKey{00C6}{{\string\idxsort{2}{\string\AE{}}}} % Æ
\DefineSortKey{00E6}{{\string\idxsort{2}{\string\AE{}}}} % æ
\DefineSortKey{00D6}{{\string\idxsort{3}{\string\"O}}} % Ö
\DefineSortKey{00F6}{{\string\idxsort{3}{\string\"O}}} % ö
