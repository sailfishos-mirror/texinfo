...
Texinfo::MODULE - Convert Texinfo tree to OUTFORMAT

=head1 SYNOPSIS

  my $converter
    = Texinfo::MODULE->converter({'NUMBER_SECTIONS' => 0});
...
Texinfo::MODULE converts a Texinfo tree to OUTFORMAT.

=head1 METHODS

=over

=item $converter = Texinfo::MODULE->converter($options)
