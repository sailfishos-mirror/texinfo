...
=head1 SYNOPSIS
  ...
  if (exists($Texinfo::Commands::brace_commands{$a_command})
      and $Texinfo::Commands::brace_commands{$a_command} eq 'accent') {
...
described in L<< C<Texinfo::Document::indices_information>|Texinfo::Document/$indices_information = $document->indices_information() >>.
...
I<accent>, I<arguments>, I<context> and other.
