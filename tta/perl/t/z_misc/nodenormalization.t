...
my $normalized_manual = convert_to_node_identifier($texinfo_manual_tree);
...
SKIP: {
  ...
  my $transliterated_line = normalize_transliterate_texinfo($line_tree, 1);
  ...
  my $transliterated_line_no_unidecode = normalize_transliterate_texinfo($line_tree, 1, 1);
...
my $effect_of_var_node_normalized
  = convert_to_node_identifier($effect_of_var_node_tree);
