...
$result_sectioning_root{'inlineraw_in_menu_description'} = 'level: -1
list:
 1|top
';
...
$result_converted{'xml'}->{'inlineraw_in_menu_description'} = '<node identifier="first"><nodename> first</nodename></node>
