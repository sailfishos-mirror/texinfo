...
$result_sectioning_root{'empty_menu_description'} = '';

$result_headings_list{'empty_menu_description'} = '';
...
$result_converted_errors{'html'}->{'empty_menu_description'} = '* W |must specify a title with a title command or @top
