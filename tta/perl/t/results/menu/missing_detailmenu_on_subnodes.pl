...
$result_errors{'missing_detailmenu_on_subnodes'} = '* W l8|node `section\' in menu in `Top\' but under `chapter\' in sectioning
 warning: node `section\' in menu in `Top\' but under `chapter\' in sectioning

* W l12|node `section chap 2\' in menu in `Top\' but under `chapter 2\' in sectioning
 warning: node `section chap 2\' in menu in `Top\' but under `chapter 2\' in sectioning

* W l13|node `unnumberedsec\' in menu in `Top\' but under `chapter 2\' in sectioning
 warning: node `unnumberedsec\' in menu in `Top\' but under `chapter 2\' in sectioning
...
<p class="nav-panel">
<span class="nav-button"><span class="nav-label">Next: </span><span class="nav-link"><a href="#section-chap-2" accesskey="n" rel="next">section chap 2</a></span></span>, <span class="nav-button"><span class="nav-label">Previous: </span><span class="nav-link"><a href="#chapter-2" accesskey="p" rel="prev">chapter 2</a></span></span>, <span class="nav-button"><span class="nav-label">Up: </span><span class="nav-link"><a href="#chapter" accesskey="u" rel="up">chapter</a></span></span><span class="nav-button"> &nbsp; </span></p>
...
<p class="nav-panel">
<span class="nav-button"><span class="nav-label">Next: </span><span class="nav-link"><a href="#section" accesskey="n" rel="next">section</a></span></span>, <span class="nav-button"><span class="nav-label">Previous: </span><span class="nav-link"><a href="#chapter" accesskey="p" rel="prev">chapter</a></span></span>, <span class="nav-button"><span class="nav-label">Up: </span><span class="nav-link"><a href="#Top" accesskey="u" rel="up">top</a></span></span><span class="nav-button"> &nbsp; </span></p>
...
<p class="nav-panel">
<span class="nav-button"><span class="nav-label">Next: </span><span class="nav-link"><a href="#unnumberedsec" accesskey="n" rel="next">unnumberedsec</a></span></span>, <span class="nav-button"><span class="nav-label">Previous: </span><span class="nav-link"><a href="#section" accesskey="p" rel="prev">section</a></span></span>, <span class="nav-button"><span class="nav-label">Up: </span><span class="nav-link"><a href="#chapter-2" accesskey="u" rel="up">chapter 2</a></span></span><span class="nav-button"> &nbsp; </span></p>
...
$result_converted{'xml'}->{'missing_detailmenu_on_subnodes'} = '<node identifier="Top"><nodename> Top</nodename><nodenext automatic="on"> chapter</nodenext></node>
...
<node identifier="section"><nodename> section</nodename><nodenext automatic="on"> section chap 2</nodenext><nodeprev automatic="on"> chapter 2</nodeprev><nodeup automatic="on"> chapter</nodeup></node>
<section><sectiontitle> section</sectiontitle>

</section>
</chapter>
<node identifier="chapter-2"><nodename> chapter 2</nodename><nodenext automatic="on"> section</nodenext><nodeprev automatic="on"> chapter</nodeprev><nodeup automatic="on"> Top</nodeup></node>
...
<node identifier="section-chap-2"><nodename> section chap 2</nodename><nodenext automatic="on"> unnumberedsec</nodenext><nodeprev automatic="on"> section</nodeprev><nodeup automatic="on"> chapter 2</nodeup></node>
