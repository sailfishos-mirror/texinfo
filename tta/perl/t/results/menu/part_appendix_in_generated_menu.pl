...
$result_trees{'part_appendix_in_generated_menu'} = {
  'contents' => [
    {
...
$result_trees{'part_appendix_in_generated_menu'}{'contents'}[9]{'extra'}{'associated_part'} = $result_trees{'part_appendix_in_generated_menu'}{'contents'}[7];
...
$result_sectioning{'part_appendix_in_generated_menu'} = {
  'extra' => {
    'section_childs' => [
      {
        'cmdname' => 'top',
...
$result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0];
$result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0];
$result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'prev'} = $result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0];
$result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'up'} = $result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0];
$result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'sectioning_root'} = $result_sectioning{'part_appendix_in_generated_menu'};
$result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[1]{'extra'}{'part_associated_section'}{'extra'}{'associated_part'} = $result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[1];
$result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[1]{'extra'}{'part_associated_section'}{'extra'}{'section_directions'}{'up'} = $result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[1];
$result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[1]{'extra'}{'part_associated_section'}{'extra'}{'toplevel_directions'}{'prev'} = $result_sectioning{'part_appendix_in_generated_menu'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0];
...
$result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'};
$result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'part_appendix_in_generated_menu'}[0];
$result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'};
$result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'part_appendix_in_generated_menu'}[0];
$result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_preceding_part'} = $result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'associated_section'}{'extra'}{'associated_part'};
$result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'part_appendix_in_generated_menu'}[0];
$result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'part_appendix_in_generated_menu'}[0];
$result_nodes{'part_appendix_in_generated_menu'}[1] = $result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'};
$result_nodes{'part_appendix_in_generated_menu'}[2]{'extra'}{'node_directions'}{'up'} = $result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'};
$result_nodes{'part_appendix_in_generated_menu'}[3] = $result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'};
$result_nodes{'part_appendix_in_generated_menu'}[4] = $result_nodes{'part_appendix_in_generated_menu'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'next'};

$result_menus{'part_appendix_in_generated_menu'} = [
  {
    'extra' => {
      'normalized' => 'Top'
    }
...
$result_floats{'part_appendix_in_generated_menu'} = {};
