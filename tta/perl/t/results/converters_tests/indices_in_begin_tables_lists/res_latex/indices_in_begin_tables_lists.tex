...
Something
\index[cp]{in example itemize before item 1@in example itemize before item 1}%
\index[cp]{in example itemize before item 2@in example itemize before item 2}%
\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily second item

\index[cp]{in example itemize alone before item@in example itemize alone before item}%
\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily 
\index[cp]{in example itemize before comment@in example itemize before comment}%
\index[cp]{in example itemize after comment@in example itemize after comment}%
\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily item after entry and comment

\index[cp]{before comment@before comment}%
\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily comment and entry
