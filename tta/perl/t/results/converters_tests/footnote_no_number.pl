...
$result_sectioning_root{'footnote_no_number'} = 'level: -1
list:
 1|top
';
...
$result_converted{'xml'}->{'footnote_no_number'} = '<node identifier="Top"><nodename> Top</nodename><nodenext automatic="on"> chap</nodenext></node>
...
$result_converted{'latex_text'}->{'footnote_no_number'} = '\\begin{document}
\\label{anchor:Top}%
...
$result_converted{'info'}->{'footnote_no_number'} = Encode::encode('utf-8', 'This is , produced from .
