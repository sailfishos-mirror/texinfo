...
$result_sections_list{'inlineifsetifclear'} = '';

$result_sectioning_root{'inlineifsetifclear'} = '';

$result_headings_list{'inlineifsetifclear'} = '';
...
$result_converted{'latex_text'}->{'inlineifsetifclear'} = '\\begin{document}
iclear first .
