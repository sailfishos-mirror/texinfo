...
\ttfamily 
\index[cp]{in example itemize before line@in example itemize before line}%
...
\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily \index[cp]{in example itemize before item 1@in example itemize before item 1}%
\index[cp]{in example itemize before item 2@in example itemize before item 2}%
second item

\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily \index[cp]{in example itemize alone before item@in example itemize alone before item}%

\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily \index[cp]{in example itemize before comment@in example itemize before comment}%
\index[cp]{in example itemize after comment@in example itemize after comment}%
item after entry and comment

\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily \index[cp]{before comment@before comment}%
comment and entry

\index[cp]{before text@before text}%
Some thing in pre
\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily more item

\index[cp]{before text and comment@before text and comment}%
Some content
\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily another one item
\end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily \end{Texinfopreformatted}
\item \begin{Texinfopreformatted}%
\ttfamily \index[cp]{direct in item in preformatted@direct in item in preformatted}%
last item
\end{Texinfopreformatted}
\end{itemize}
\end{Texinfoindented}
