...
$result_sectioning_root{'test_formatting_customizations'} = 'level: -1
list:
 1|top
';
...
$result_converted{'xml'}->{'test_formatting_customizations'} = '<node identifier="Top"><nodename> Top</nodename><nodenext automatic="on"> chapt</nodenext></node>
