...
$result_sectioning_root{'contents_at_document_begin'} = 'level: -1
list:
...
$result_converted{'info'}->{'contents_at_document_begin'} = Encode::encode('utf-8', 'This is , produced from contents_at_document_begin.texi.
