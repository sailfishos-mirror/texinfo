...
$result_trees{'anchor_in_titlepage_titlepage'}{'contents'}[4]{'contents'}[2]{'contents'}[0]{'contents'}[0]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'anchor_in_titlepage_titlepage'}{'contents'}[4]{'contents'}[2]{'contents'}[0]{'contents'}[0]{'contents'}[0];
...
$result_nodes{'anchor_in_titlepage_titlepage'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'anchor_in_titlepage_titlepage'}[0];
$result_nodes{'anchor_in_titlepage_titlepage'}[1] = $result_nodes{'anchor_in_titlepage_titlepage'}[0]{'extra'}{'node_directions'}{'next'};
