...
$result_trees{'alias_of_added_index_before_added_index'}{'contents'}[2]{'contents'}[2]{'extra'}{'element_node'} = $result_trees{'alias_of_added_index_before_added_index'}{'contents'}[1];
