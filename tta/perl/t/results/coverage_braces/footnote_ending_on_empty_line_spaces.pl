...
$result_sections_list{'footnote_ending_on_empty_line_spaces'} = '';

$result_sectioning_root{'footnote_ending_on_empty_line_spaces'} = '';

$result_headings_list{'footnote_ending_on_empty_line_spaces'} = '';
