...
$result_errors{'math_bracketed_not_closed'} = '* E l1|misplaced {
 misplaced {
...
$result_nodes_list{'math_bracketed_not_closed'} = '';

$result_sections_list{'math_bracketed_not_closed'} = '';

$result_sectioning_root{'math_bracketed_not_closed'} = '';

$result_headings_list{'math_bracketed_not_closed'} = '';
