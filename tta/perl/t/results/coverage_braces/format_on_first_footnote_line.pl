...
$result_sections_list{'format_on_first_footnote_line'} = '';

$result_sectioning_root{'format_on_first_footnote_line'} = '';

$result_headings_list{'format_on_first_footnote_line'} = '';
