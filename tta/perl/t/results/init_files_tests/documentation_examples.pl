...
$result_sectioning_root{'documentation_examples'} = 'level: -1
list:
 1|top
';
...
$result_converted_errors{'file_html'}->{'documentation_examples'} = '* W l58|@node `Index\' file index.html for redirection exists
