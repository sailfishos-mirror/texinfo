...
$result_sections_list{'button_replacement_and_direction_customization'} = '1|top
...
$result_sectioning_root{'button_replacement_and_direction_customization'} = 'level: -1
list:
 1|top
';
