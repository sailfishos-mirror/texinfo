...
$result_sections_list{'incorrect_allowcodebreaks_argument'} = '';

$result_sectioning_root{'incorrect_allowcodebreaks_argument'} = '';

$result_headings_list{'incorrect_allowcodebreaks_argument'} = '';
