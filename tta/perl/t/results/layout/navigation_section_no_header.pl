...
$result_nodes_list{'navigation_section_no_header'} = '1|Top
...
$result_sections_list{'navigation_section_no_header'} = '1|File used for navigation testing
...
$result_sectioning_root{'navigation_section_no_header'} = 'level: -1
list:
