...
$result_tree_text{'navigation_chapter_no_header_vertical'} = '*document_root C10
...
$result_sections_list{'navigation_chapter_no_header_vertical'} = '1|File used for navigation testing
...
$result_sectioning_root{'navigation_chapter_no_header_vertical'} = 'level: -1
list:
