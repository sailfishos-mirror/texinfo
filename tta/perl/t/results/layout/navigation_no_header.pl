...
$result_tree_text{'navigation_no_header'} = '*document_root C10
...
$result_nodes_list{'navigation_no_header'} = '1|Top
...
$result_sectioning_root{'navigation_no_header'} = 'level: -1
list:
