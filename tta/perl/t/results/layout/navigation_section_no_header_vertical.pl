...
$result_sections_list{'navigation_section_no_header_vertical'} = '1|File used for navigation testing
...
$result_sectioning_root{'navigation_section_no_header_vertical'} = 'level: -1
list:
