...
$result_tree_text{'navigation_chapter_no_header'} = '*document_root C10
...
$result_nodes_list{'navigation_chapter_no_header'} = '1|Top
...
$result_sections_list{'navigation_chapter_no_header'} = '1|File used for navigation testing
...
$result_sectioning_root{'navigation_chapter_no_header'} = 'level: -1
list:
