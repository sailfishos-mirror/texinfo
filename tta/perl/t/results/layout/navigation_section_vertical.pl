...
$result_tree_text{'navigation_section_vertical'} = '*document_root C10
...
$result_nodes_list{'navigation_section_vertical'} = '1|Top
...
$result_sections_list{'navigation_section_vertical'} = '1|File used for navigation testing
...
$result_sectioning_root{'navigation_section_vertical'} = 'level: -1
list:
