...
$result_tree_text{'navigation_test_undef_top_buttons'} = '*document_root C10
...
$result_nodes_list{'navigation_test_undef_top_buttons'} = '1|Top
...
$result_sections_list{'navigation_test_undef_top_buttons'} = '1|File used for navigation testing
...
$result_sectioning_root{'navigation_test_undef_top_buttons'} = 'level: -1
list:
