...
$result_nodes_list{'navigation_no_header_vertical'} = '1|Top
...
$result_sections_list{'navigation_no_header_vertical'} = '1|File used for navigation testing
...
$result_sectioning_root{'navigation_no_header_vertical'} = 'level: -1
list:
