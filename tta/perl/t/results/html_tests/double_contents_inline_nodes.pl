...
$result_tree_text{'double_contents_inline_nodes'} = '*document_root C8
...
$result_nodes_list{'double_contents_inline_nodes'} = '1|Top
...
$result_sectioning_root{'double_contents_inline_nodes'} = 'level: -1
list:
 1|Double contents
';
