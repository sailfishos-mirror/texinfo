...
$result_tree_text{'test_accents_sc_default_usascii'} = '*document_root C5
...
$result_nodes_list{'test_accents_sc_default_usascii'} = '1|top
...
$result_sectioning_root{'test_accents_sc_default_usascii'} = 'level: -1
list:
 1|top section
';
