...
$result_tree_text{'test_accents_sc_to_utf8_latin1'} = '*document_root C5
...
$result_nodes_list{'test_accents_sc_to_utf8_latin1'} = '1|top
...
$result_sectioning_root{'test_accents_sc_to_utf8_latin1'} = 'level: -1
list:
 1|top section
';
