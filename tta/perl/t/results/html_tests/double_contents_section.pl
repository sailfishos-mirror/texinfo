...
$result_tree_text{'double_contents_section'} = '*document_root C8
...
$result_nodes_list{'double_contents_section'} = '1|Top
...
$result_sectioning_root{'double_contents_section'} = 'level: -1
list:
 1|Double contents
';
