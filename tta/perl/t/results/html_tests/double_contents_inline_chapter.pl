...
$result_tree_text{'double_contents_inline_chapter'} = '*document_root C8
...
$result_nodes_list{'double_contents_inline_chapter'} = '1|Top
...
$result_sectioning_root{'double_contents_inline_chapter'} = 'level: -1
list:
 1|Double contents
';
