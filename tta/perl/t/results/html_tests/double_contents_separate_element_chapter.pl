...
$result_tree_text{'double_contents_separate_element_chapter'} = '*document_root C8
...
$result_sections_list{'double_contents_separate_element_chapter'} = '1|Double contents
...
$result_sectioning_root{'double_contents_separate_element_chapter'} = 'level: -1
list:
 1|Double contents
';
