...
$result_nodes_list{'command_in_node_redirection_other_command'} = '1|Top
 associated_section: t @r{in r}
 associated_title_command: t @r{in r}
';

$result_sections_list{'command_in_node_redirection_other_command'} = '1|t @r{in r}
 associated_anchor_command: Top
 associated_node: Top
';

$result_sectioning_root{'command_in_node_redirection_other_command'} = 'level: -1
list:
 1|t @r{in r}
';

$result_headings_list{'command_in_node_redirection_other_command'} = '';
