...
$result_tree_text{'top_node_up_implicit'} = '*document_root C5
 *before_node_section
 *@node C1 l1 {Top}
 |INFO
...
$result_nodes_list{'top_node_up_implicit'} = '1|Top
...
$result_sectioning_root{'top_node_up_implicit'} = 'level: -1
list:
 1|The top
';
...
<p class="nav-panel">
<span class="nav-button"><span class="nav-label">Next: </span><span class="nav-link"><a href="#Chap" accesskey="n" rel="next">A chapter</a></span></span>, <span class="nav-button"><span class="nav-label">Up: </span><span class="nav-link"><a href="http://itop.example.org" accesskey="u" rel="up">(dir)</a></span></span><span class="nav-button"> &nbsp; </span></p>
...
<p class="nav-panel">
<span class="nav-button"><span class="nav-label">Previous: </span><span class="nav-link"><a href="#Top" accesskey="p" rel="prev">The top</a></span></span>, <span class="nav-button"><span class="nav-label">Up: </span><span class="nav-link"><a href="#Top" accesskey="u" rel="up">The top</a></span></span><span class="nav-button"> &nbsp; </span></p>
