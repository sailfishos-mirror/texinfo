...
$result_tree_text{'info_js_dir_html_file_js_weblabels_file_undef'} = '*document_root C5
...
$result_sectioning_root{'info_js_dir_html_file_js_weblabels_file_undef'} = 'level: -1
list:
 1|top
';
