...
$result_trees{'top_node_up_explicit'}{'contents'}[1]{'contents'}[0]{'contents'}[1]{'extra'}{'manual_content'}{'contents'}[0] = $result_trees{'top_node_up_explicit'}{'contents'}[1]{'contents'}[0]{'contents'}[1]{'contents'}[1];
$result_trees{'top_node_up_explicit'}{'contents'}[1]{'contents'}[0]{'contents'}[2]{'extra'}{'manual_content'}{'contents'}[0] = $result_trees{'top_node_up_explicit'}{'contents'}[1]{'contents'}[0]{'contents'}[2]{'contents'}[1];
$result_trees{'top_node_up_explicit'}{'contents'}[1]{'contents'}[0]{'contents'}[3]{'extra'}{'manual_content'}{'contents'}[0] = $result_trees{'top_node_up_explicit'}{'contents'}[1]{'contents'}[0]{'contents'}[3]{'contents'}[1];
$result_trees{'top_node_up_explicit'}{'contents'}[2]{'contents'}[4]{'contents'}[1]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'top_node_up_explicit'}{'contents'}[2]{'contents'}[4]{'contents'}[1]{'contents'}[1]{'contents'}[0];
...
$result_sectioning{'top_node_up_explicit'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'up'} = $result_sectioning{'top_node_up_explicit'}{'extra'}{'section_childs'}[0];
...
$result_menus{'top_node_up_explicit'}[1]{'extra'}{'menu_directions'}{'up'} = $result_menus{'top_node_up_explicit'}[0];
