...
$result_errors{'nodedescription_description_no_use_nodes'} = '* W l7|@verb should not appear on @nodedescription line
...
$result_sectioning_root{'nodedescription_description_no_use_nodes'} = 'level: -1
list:
