...
$result_sections_list{'test_accents_sc_enable_encoding_to_utf8_latin1'} = '1|top section
...
$result_sectioning_root{'test_accents_sc_enable_encoding_to_utf8_latin1'} = 'level: -1
list:
 1|top section
';
