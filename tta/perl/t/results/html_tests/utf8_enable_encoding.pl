...
$result_tree_text{'utf8_enable_encoding'} = '*document_root C1
...
$result_sections_list{'utf8_enable_encoding'} = '';

$result_sectioning_root{'utf8_enable_encoding'} = '';

$result_headings_list{'utf8_enable_encoding'} = '';
