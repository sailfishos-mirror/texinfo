...
$result_errors{'check_htmlxref_ignore_ref_top_up'} = '* W l9|node `first\' in menu where `chapter\' expected
...
$result_sectioning_root{'check_htmlxref_ignore_ref_top_up'} = 'level: -1
list:
 1|top
';
...
$result_converted_errors{'html'}->{'check_htmlxref_ignore_ref_top_up'} = '* W l2|no HTML cross-references entry found for `../there/no_existing_no_manual_direction\'
