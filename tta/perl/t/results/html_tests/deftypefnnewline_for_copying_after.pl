...
$result_trees{'deftypefnnewline_for_copying_after'}{'contents'}[4]{'contents'}[2]{'contents'}[0]{'extra'}{'element_node'} = $result_trees{'deftypefnnewline_for_copying_after'}{'contents'}[3];
