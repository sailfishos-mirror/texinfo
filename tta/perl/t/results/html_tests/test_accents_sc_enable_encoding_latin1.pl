...
$result_tree_text{'test_accents_sc_enable_encoding_latin1'} = '*document_root C5
...
$result_sections_list{'test_accents_sc_enable_encoding_latin1'} = '1|top section
...
$result_sectioning_root{'test_accents_sc_enable_encoding_latin1'} = 'level: -1
list:
 1|top section
';
