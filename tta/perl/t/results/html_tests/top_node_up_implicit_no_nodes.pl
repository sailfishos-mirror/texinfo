...
$result_nodes_list{'top_node_up_implicit_no_nodes'} = '1|Top
...
$result_sectioning_root{'top_node_up_implicit_no_nodes'} = 'level: -1
list:
 1|The top
';
...
<div class="nav-panel">
<p>
<span class="nav-button"> Up : <a href="http://itop.example.org" accesskey="u" rel="up">(dir)</a></span><span class="nav-button"> &nbsp; </span></p>
</div>
...
<div class="nav-panel">
<p>
<span class="nav-button"> Up : <a href="#Top" accesskey="u" rel="up">The top</a></span><span class="nav-button"> &nbsp; </span></p>
</div>
