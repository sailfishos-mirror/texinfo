...
$result_sections_list{'command_in_node_redirection_multiple'} = '1|t @r{in r}
 associated_anchor_command: Top
 associated_node: Top
';

$result_sectioning_root{'command_in_node_redirection_multiple'} = 'level: -1
list:
 1|t @r{in r}
';

$result_headings_list{'command_in_node_redirection_multiple'} = '';
