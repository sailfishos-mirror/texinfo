...
$result_nodes_list{'float_type_with_tieaccent'} = '';

$result_sections_list{'float_type_with_tieaccent'} = '';

$result_sectioning_root{'float_type_with_tieaccent'} = '';

$result_headings_list{'float_type_with_tieaccent'} = '';
