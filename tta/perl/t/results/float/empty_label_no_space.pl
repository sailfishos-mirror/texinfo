...
$result_nodes_list{'empty_label_no_space'} = '';

$result_sections_list{'empty_label_no_space'} = '';

$result_sectioning_root{'empty_label_no_space'} = '';

$result_headings_list{'empty_label_no_space'} = '';
...
$result_converted_errors{'html'}->{'empty_label_no_space'} = '* W |must specify a title with a title command or @top
