...
$result_nodes_list{'empty_label_with_space'} = '';

$result_sections_list{'empty_label_with_space'} = '';

$result_sectioning_root{'empty_label_with_space'} = '';

$result_headings_list{'empty_label_with_space'} = '';
...
$result_converted_errors{'html'}->{'empty_label_with_space'} = '* W |must specify a title with a title command or @top
 warning: must specify a title with a title command or @top

';


$result_converted{'xml'}->{'empty_label_with_space'} = '<float type="Type" endspaces=" "><floattype> Type</floattype><floatname spaces=" "></floatname>
</float>
';
