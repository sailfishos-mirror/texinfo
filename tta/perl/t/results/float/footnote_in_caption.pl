...
$result_trees{'footnote_in_caption'}{'contents'}[2]{'contents'}[4]{'contents'}[2]{'extra'}{'float'} = $result_trees{'footnote_in_caption'}{'contents'}[2]{'contents'}[4];
$result_trees{'footnote_in_caption'}{'contents'}[2]{'contents'}[4]{'extra'}{'caption'} = $result_trees{'footnote_in_caption'}{'contents'}[2]{'contents'}[4]{'contents'}[2];
