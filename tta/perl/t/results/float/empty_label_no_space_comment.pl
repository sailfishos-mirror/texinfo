...
$result_tree_text{'empty_label_no_space_comment'} = '*document_root C1
...
$result_sectioning_root{'empty_label_no_space_comment'} = '';
...
$result_converted_errors{'html'}->{'empty_label_no_space_comment'} = '* W |must specify a title with a title command or @top
 warning: must specify a title with a title command or @top

';


$result_converted{'xml'}->{'empty_label_no_space_comment'} = '<float type="Type" endspaces=" "><floattype> Type</floattype><floatname></floatname><!-- c comment -->
</float>
';
