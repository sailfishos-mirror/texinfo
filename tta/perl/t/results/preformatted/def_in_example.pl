...
$result_sections_list{'def_in_example'} = '';

$result_sectioning_root{'def_in_example'} = '';

$result_headings_list{'def_in_example'} = '';
...
$result_converted{'latex_text'}->{'def_in_example'} = '\\begin{document}
