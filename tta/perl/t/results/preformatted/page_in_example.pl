...
$result_converted_errors{'html'}->{'page_in_example'} = '* W |must specify a title with a title command or @top
...
$result_converted{'latex_text'}->{'page_in_example'} = '\\begin{document}
