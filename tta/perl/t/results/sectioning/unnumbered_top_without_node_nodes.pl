...
$result_converted{'info'}->{'unnumbered_top_without_node_nodes'} = Encode::encode('utf-8', 'This is , produced from .
...
$result_converted_errors{'info'}->{'unnumbered_top_without_node_nodes'} = '* W |document without Top node
