...
$result_trees{'two_nodes_between_chapters'}[0]{'unit_command'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'two_nodes_between_chapters'}[0]{'unit_command'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'contents'}[0];
$result_trees{'two_nodes_between_chapters'}[0]{'unit_command'}{'contents'}[2]{'contents'}[2]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'two_nodes_between_chapters'}[0]{'unit_command'}{'contents'}[2]{'contents'}[2]{'contents'}[1]{'contents'}[0];
$result_trees{'two_nodes_between_chapters'}[0]{'unit_command'}{'contents'}[2]{'contents'}[3]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'two_nodes_between_chapters'}[0]{'unit_command'}{'contents'}[2]{'contents'}[3]{'contents'}[1]{'contents'}[0];
$result_trees{'two_nodes_between_chapters'}[0]{'unit_contents'}[2] = $result_trees{'two_nodes_between_chapters'}[0]{'unit_command'};
$result_trees{'two_nodes_between_chapters'}[1]{'unit_contents'}[0]{'contents'}[0]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'two_nodes_between_chapters'}[1]{'unit_contents'}[0]{'contents'}[0]{'contents'}[1]{'contents'}[0];
$result_trees{'two_nodes_between_chapters'}[1]{'unit_contents'}[0]{'contents'}[0]{'contents'}[2]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'two_nodes_between_chapters'}[1]{'unit_contents'}[0]{'contents'}[0]{'contents'}[2]{'contents'}[0];
$result_trees{'two_nodes_between_chapters'}[1]{'unit_contents'}[0]{'contents'}[0]{'contents'}[3]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'two_nodes_between_chapters'}[1]{'unit_contents'}[0]{'contents'}[0]{'contents'}[3]{'contents'}[0];
