...
$result_nodes_list{'nodes_after_top_before_chapter_no_use_nodes_chapter'} = '1|Top
 menus:
  second node
  third node
 node_directions:
...
$result_sections_list{'nodes_after_top_before_chapter_no_use_nodes_chapter'} = '1|chapter
 associated_anchor_command: third node
 associated_node: third node
';

$result_sectioning_root{'nodes_after_top_before_chapter_no_use_nodes_chapter'} = 'level: 0
list:
 1|chapter
';

$result_headings_list{'nodes_after_top_before_chapter_no_use_nodes_chapter'} = '';

$result_converted_errors{'file_html'}->{'nodes_after_top_before_chapter_no_use_nodes_chapter'} = '* W nodes_after_top_before_chapter_no_use_nodes_chapter.texi|must specify a title with a title command or @top
