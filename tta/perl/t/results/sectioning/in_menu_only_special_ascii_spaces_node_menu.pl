...
$result_converted{'info'}->{'in_menu_only_special_ascii_spaces_node_menu'} = Encode::encode('utf-8', 'This is , produced from in_menu_only_special_ascii_spaces_node.texi.
