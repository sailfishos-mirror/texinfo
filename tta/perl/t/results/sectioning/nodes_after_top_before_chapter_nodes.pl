...
$result_sectioning_root{'nodes_after_top_before_chapter_nodes'} = 'level: 0
list:
 1|chapter
';
...
$result_converted_errors{'html'}->{'nodes_after_top_before_chapter_nodes'} = '* W |must specify a title with a title command or @top
