...
$result_converted{'info'}->{'part_node_chapter_appendix'} = Encode::encode('utf-8', 'This is , produced from .
...
$result_converted{'xml'}->{'part_node_chapter_appendix'} = '<node identifier="Top"><nodename> Top</nodename><nodenext automatic="on"> chapter node</nodenext></node>
