  ...
  *@menu C3 l4
   ...
   *@end C1 l6
    ...
    *line_arg C3
     ...
     {spaces_after_argument:\\n}
  {empty_line:\\n}
 *@node C1 l8 {chap part node after top}
 |EXTRA
...
$result_converted{'info'}->{'part_node_after_top'} = Encode::encode('utf-8', 'This is , produced from .
...
<hr>
<a class="node-id" id="chap-part-node-after-top"></a><p class="nav-panel">
...
$result_converted{'xml'}->{'part_node_after_top'} = '<node identifier="Top"><nodename> Top</nodename><nodenext automatic="on"> chap part node after top</nodenext></node>
...
<node identifier="chap-part-node-after-top"><nodename> chap part node after top</nodename><nodeprev automatic="on"> Top</nodeprev><nodeup automatic="on"> Top</nodeup></node>
