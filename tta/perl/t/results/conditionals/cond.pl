...
$result_nodes{'cond'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'cond'}[0];
$result_nodes{'cond'}[1] = $result_nodes{'cond'}[0]{'extra'}{'node_directions'}{'next'};
