...
$result_tree_text{'htmlxref_only_mono_nodes'} = '*document_root C9
...
$result_nodes_list{'htmlxref_only_mono_nodes'} = '1|Top
...
$result_sectioning_root{'htmlxref_only_mono_nodes'} = 'level: -1
list:
 1|Test refs
';
