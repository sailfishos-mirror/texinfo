   ...
   *@end C1 test_refs.texi:l34
    ...
    *line_arg C1
    ...
    |spaces_after_argument:
     ...
     {example}
  {empty_line:\\n}
  *4 @subheading C1 test_refs.texi:l36
  |INFO
  |spaces_before_argument:
   |{ }
  |EXTRA
   ...
   *@end C1 test_refs.texi:l42
    ...
    *line_arg C1
    ...
    |spaces_after_argument:
     ...
     {example}
  {empty_line:\\n}
  *5 @subheading C1 test_refs.texi:l44
  |INFO
  |spaces_before_argument:
   |{ }
  |EXTRA
   ...
   *@end C1 test_refs.texi:l64
    ...
    *line_arg C1
    ...
    |spaces_after_argument:
     ...
     {example}
  {empty_line:\\n}
 *6 @node C1 test_refs.texi:l66 {other nodes}
 |INFO
 |spaces_before_argument:
  |{ }
 |EXTRA
  ...
  *arguments_line C4
   ...
   *line_arg C1
   ...
   |normalized:{Top}
    {Top}
 *7 @chapter C9 test_refs.texi:l67 {Chapter with nodes}
 |INFO
 |spaces_before_argument:
  |{ }
 |EXTRA
   ...
   *@end C1 test_refs.texi:l82
    ...
    *line_arg C1
    ...
    |spaces_after_argument:
     ...
     {menu}
  {empty_line:\\n}
 *9 @node C3 test_refs.texi:l84 {!_"#$%&\'()*+-.}
 |INFO
 |spaces_before_argument:
  |{ }
 |EXTRA
   ...
   *@end C1 test_refs.texi:l87
    ...
    *line_arg C1
    ...
    |spaces_after_argument:
     ...
     {example}
  {empty_line:\\n}
 *10 @node C3 test_refs.texi:l89 {/;<=>?[\\]^_`|~}
 |INFO
 |spaces_before_argument:
  |{ }
 |EXTRA
   ...
   *@end C1 test_refs.texi:l92
    ...
    *line_arg C1
    ...
    |spaces_after_argument:
     ...
     {example}
  {empty_line:\\n}
 *11 @node C3 test_refs.texi:l94 {local   node}
 |INFO
 |spaces_before_argument:
  |{  }
 |EXTRA
...
$result_sectioning_root{'htmlxref'} = 'level: -1
list:
 1|Test refs
';
