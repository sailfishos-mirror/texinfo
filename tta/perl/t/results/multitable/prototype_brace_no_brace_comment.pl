...
$result_converted{'xml'}->{'prototype_brace_no_brace_comment'} = '<multitable endspaces=" "><columnprototypes> <columnprototype bracketed="on">aa</columnprototype> bb<!-- comment cc -->
</columnprototypes><!-- comment cc -->
</multitable>
';
