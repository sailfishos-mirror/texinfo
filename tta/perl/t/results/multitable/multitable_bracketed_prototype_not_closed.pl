...
$result_sections_list{'multitable_bracketed_prototype_not_closed'} = '';

$result_sectioning_root{'multitable_bracketed_prototype_not_closed'} = '';

$result_headings_list{'multitable_bracketed_prototype_not_closed'} = '';
