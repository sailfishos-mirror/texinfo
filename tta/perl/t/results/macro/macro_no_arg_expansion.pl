...
$result_sections_list{'macro_no_arg_expansion'} = '';

$result_sectioning_root{'macro_no_arg_expansion'} = '';

$result_headings_list{'macro_no_arg_expansion'} = '';
