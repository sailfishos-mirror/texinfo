...
$result_sections_list{'macro_call_in_inlinefmtifelse_format'} = '';

$result_sectioning_root{'macro_call_in_inlinefmtifelse_format'} = '';

$result_headings_list{'macro_call_in_inlinefmtifelse_format'} = '';
