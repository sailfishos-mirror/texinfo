...
$result_sections_list{'macro_expansion_end_in_ignored_ifset_content'} = '';

$result_sectioning_root{'macro_expansion_end_in_ignored_ifset_content'} = '';

$result_headings_list{'macro_expansion_end_in_ignored_ifset_content'} = '';
