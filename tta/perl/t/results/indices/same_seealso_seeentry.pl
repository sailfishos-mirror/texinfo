...
$result_tree_text{'same_seealso_seeentry'} = '*document_root C5
   ...
   *line_arg C3
    ...
    *15 @seeentry C1 l14
     *brace_arg C1
      {entry}
  {empty_line:\\n}
  *16 index_entry_command@cindex C1 l16
  |INFO
  |command_name:{cindex}
  |spaces_before_argument:
   |{ }
...
$result_converted{'xml'}->{'same_seealso_seeentry'} = '<node identifier="Top" spaces=" "><nodename>Top</nodename><nodenext automatic="on">node</nodenext></node>
