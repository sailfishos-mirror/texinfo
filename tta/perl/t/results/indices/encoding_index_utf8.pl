...
$result_tree_text{'encoding_index_utf8'} = '*document_root C5
...
$result_errors{'encoding_index_utf8'} = '* W encoding_index_utf8.texi:l7|node `chap\' not in menu
...
$result_sectioning_root{'encoding_index_utf8'} = 'level: -1
list:
 1|encoding index utf8
';

$result_headings_list{'encoding_index_utf8'} = '';
...
$result_converted_sort_strings{'file_html'}->{'encoding_index_utf8'} = 'cp:
 -
 --
 ,
 ¡
...
$result_converted_sort_strings{'file_plaintext'}->{'encoding_index_utf8'} = 'cp:
 -
 --
 ,
 ¡
...
$result_converted_sort_strings{'file_info'}->{'encoding_index_utf8'} = 'cp:
 -
 --
 ,
 ¡
