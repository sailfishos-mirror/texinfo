...
$result_errors{'index_table_chapter_no_node'} = '* E index_table.texi:l21|command @bullet not accepting argument in brace should not be on @vtable line
...
$result_converted_sort_strings{'file_html'}->{'index_table_chapter_no_node'} = 'cp:
 ,oncept
 ;oncept
 !oncept
 ?oncept
...
$result_converted_sort_strings{'file_plaintext'}->{'index_table_chapter_no_node'} = 'cp:
 ,oncept
 ;oncept
 !oncept
 ?oncept
