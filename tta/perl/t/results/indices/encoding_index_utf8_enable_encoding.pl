...
$result_errors{'encoding_index_utf8_enable_encoding'} = '* W encoding_index_utf8.texi:l7|node `chap\' not in menu
 warning: node `chap\' not in menu

';

$result_nodes_list{'encoding_index_utf8_enable_encoding'} = '1|Top
...
$result_sections_list{'encoding_index_utf8_enable_encoding'} = '1|encoding index utf8
 associated_anchor_command: Top
 associated_node: Top
';

$result_sectioning_root{'encoding_index_utf8_enable_encoding'} = 'level: -1
list:
 1|encoding index utf8
';

$result_headings_list{'encoding_index_utf8_enable_encoding'} = '';
...
$result_converted_sort_strings{'file_html'}->{'encoding_index_utf8_enable_encoding'} = 'cp:
 -
 --
 ,
 ¡
...
$result_converted_sort_strings{'file_plaintext'}->{'encoding_index_utf8_enable_encoding'} = 'cp:
 -
 --
 ,
 ¡
...
$result_converted_sort_strings{'file_info'}->{'encoding_index_utf8_enable_encoding'} = 'cp:
 -
 --
 ,
 ¡
