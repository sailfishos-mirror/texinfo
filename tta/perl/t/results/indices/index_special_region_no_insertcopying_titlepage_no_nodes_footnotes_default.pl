...
$result_tree_text{'index_special_region_no_insertcopying_titlepage_no_nodes_footnotes_default'} = '*document_root C7
...
$result_errors{'index_special_region_no_insertcopying_titlepage_no_nodes_footnotes_default'} = '* W index_special_region_no_insertcopying.texi:l47|@cindex missing argument
...
$result_nodes_list{'index_special_region_no_insertcopying_titlepage_no_nodes_footnotes_default'} = '1|Top
...
$result_sections_list{'index_special_region_no_insertcopying_titlepage_no_nodes_footnotes_default'} = '1|Top
...
$result_sectioning_root{'index_special_region_no_insertcopying_titlepage_no_nodes_footnotes_default'} = 'level: -1
list:
 1|Top
';
...
$result_indices_sort_strings{'index_special_region_no_insertcopying_titlepage_no_nodes_footnotes_default'} = 'cp:
 Copying appendix
 Copying this document
 Public domain
 Titlepage footnote
