...
$result_converted_sort_strings{'file_info'}->{'index_table'} = 'cp:
 ,oncept
 ;oncept
 !oncept
 ?oncept
...
$result_converted_sort_strings{'file_html'}->{'index_table'} = 'cp:
 ,oncept
 ;oncept
 !oncept
 ?oncept
...
$result_converted_sort_strings{'file_plaintext'}->{'index_table'} = 'cp:
 ,oncept
 ;oncept
 !oncept
 ?oncept
