...
$result_sectioning_root{'empty_cindex_entry'} = '';
...
$result_converted{'xml'}->{'empty_cindex_entry'} = '<node identifier="Top"><nodename> Top</nodename><nodenext automatic="on"> chap</nodenext></node>
