...
$result_tree_text{'index_special_region_titlepage_no_nodes'} = '*document_root C7
...
$result_errors{'index_special_region_titlepage_no_nodes'} = '* W index_special_region.texi:l44|@cindex missing argument
...
$result_sectioning_root{'index_special_region_titlepage_no_nodes'} = 'level: -1
list:
 1|Top
';
