...
$result_errors{'nodes_before_top_split_chapter'} = '* W nodes_before_top.texi:l6|node `first before top\' not in menu
 warning: node `first before top\' not in menu

';

$result_nodes_list{'nodes_before_top_split_chapter'} = '1|first before top
 menus:
  node in menu before top
 node_directions:
  next->Top
...
$result_sections_list{'nodes_before_top_split_chapter'} = '';

$result_sectioning_root{'nodes_before_top_split_chapter'} = '';

$result_headings_list{'nodes_before_top_split_chapter'} = '';
...
$result_converted_sort_strings{'file_html'}->{'nodes_before_top_split_chapter'} = 'cp:
 ! entry in node
 a concept a node
 another
 entry a
