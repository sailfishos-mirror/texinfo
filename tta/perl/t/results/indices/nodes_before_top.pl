...
$result_tree_text{'nodes_before_top'} = '*document_root C9
...
$result_errors{'nodes_before_top'} = '* W nodes_before_top.texi:l6|node `first before top\' not in menu
...
$result_sectioning_root{'nodes_before_top'} = '';
