...
$result_tree_text{'accent'} = '*document_root C3
...
$result_nodes_list{'accent'} = '1|first
 associated_section: top
 associated_title_command: top
';

$result_sections_list{'accent'} = '1|top
 associated_anchor_command: first
 associated_node: first
';

$result_sectioning_root{'accent'} = 'level: -1
list:
 1|top
';

$result_headings_list{'accent'} = '';
...
$result_converted{'xml'}->{'accent'} = '<node identifier="first"><nodename> first</nodename></node>
