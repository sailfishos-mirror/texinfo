...
$result_tree_text{'char_latin1_latin1_in_refs_output_encoding_latin1'} = '*document_root C14
...
$result_texis{'char_latin1_latin1_in_refs_output_encoding_latin1'} = '\\input texinfo
...
$result_texts{'char_latin1_latin1_in_refs_output_encoding_latin1'} = '
accented char in latin1 in refs
*******************************
...
$result_errors{'char_latin1_latin1_in_refs_output_encoding_latin1'} = '';

$result_nodes_list{'char_latin1_latin1_in_refs_output_encoding_latin1'} = '1|Top
...
$result_sections_list{'char_latin1_latin1_in_refs_output_encoding_latin1'} = '1|accented char in latin1 in refs
...
$result_sectioning_root{'char_latin1_latin1_in_refs_output_encoding_latin1'} = 'level: -1
list:
 1|accented char in latin1 in refs
';

$result_headings_list{'char_latin1_latin1_in_refs_output_encoding_latin1'} = '';

$result_indices_sort_strings{'char_latin1_latin1_in_refs_output_encoding_latin1'} = 'cp:
 Ä Ë Ï Ö Ü
 â ê î ô û Â Ê Î Ô Û
 ä ë ï ö ü ÿ
 ç
...
$result_converted_sort_strings{'file_html'}->{'char_latin1_latin1_in_refs_output_encoding_latin1'} = 'cp:
 Ä Ë Ï Ö Ü
 â ê î ô û Â Ê Î Ô Û
 ä ë ï ö ü ÿ
 ç
...
$result_converted_sort_strings{'file_info'}->{'char_latin1_latin1_in_refs_output_encoding_latin1'} = 'cp:
 Ä Ë Ï Ö Ü
 â ê î ô û Â Ê Î Ô Û
 ä ë ï ö ü ÿ
 ç
