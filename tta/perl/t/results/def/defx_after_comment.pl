...
$result_errors{'defx_after_comment'} = '* W l1|entry for index `fn\' outside of any node
...
$result_nodes_list{'defx_after_comment'} = '';

$result_sections_list{'defx_after_comment'} = '';

$result_sectioning_root{'defx_after_comment'} = '';

$result_headings_list{'defx_after_comment'} = '';

$result_indices_sort_strings{'defx_after_comment'} = 'fn:
 bidulr
 i
';
