...
$result_sections_list{'all_commands_delimiters'} = '';

$result_sectioning_root{'all_commands_delimiters'} = '';

$result_headings_list{'all_commands_delimiters'} = '';
