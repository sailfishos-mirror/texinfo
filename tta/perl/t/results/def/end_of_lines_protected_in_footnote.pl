...
$result_sections_list{'end_of_lines_protected_in_footnote'} = '';

$result_sectioning_root{'end_of_lines_protected_in_footnote'} = '';

$result_headings_list{'end_of_lines_protected_in_footnote'} = '';
