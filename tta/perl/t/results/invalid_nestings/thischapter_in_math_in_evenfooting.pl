...
$result_sections_list{'thischapter_in_math_in_evenfooting'} = '';

$result_sectioning_root{'thischapter_in_math_in_evenfooting'} = '';

$result_headings_list{'thischapter_in_math_in_evenfooting'} = '';
