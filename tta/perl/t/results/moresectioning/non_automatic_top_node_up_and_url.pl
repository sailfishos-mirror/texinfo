...
$result_sectioning_root{'non_automatic_top_node_up_and_url'} = 'level: -1
list:
 1|internal top node up
';

$result_headings_list{'non_automatic_top_node_up_and_url'} = '';


$result_converted{'info'}->{'non_automatic_top_node_up_and_url'} = Encode::encode('utf-8', 'This is , produced from .
...
<span class="nav-button"><span class="nav-label">Previous: </span><span class="nav-link"><a href="#Top" accesskey="p" rel="prev">internal top node up</a></span></span><span class="nav-button"> &nbsp; </span></p>
