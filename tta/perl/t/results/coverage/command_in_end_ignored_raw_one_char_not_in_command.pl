...
$result_errors{'command_in_end_ignored_raw_one_char_not_in_command'} = '* E l1|no matching `@end html\'
...
$result_sectioning_root{'command_in_end_ignored_raw_one_char_not_in_command'} = '';

$result_headings_list{'command_in_end_ignored_raw_one_char_not_in_command'} = '';
