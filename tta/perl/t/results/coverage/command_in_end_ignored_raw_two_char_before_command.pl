...
$result_sections_list{'command_in_end_ignored_raw_two_char_before_command'} = '';

$result_sectioning_root{'command_in_end_ignored_raw_two_char_before_command'} = '';

$result_headings_list{'command_in_end_ignored_raw_two_char_before_command'} = '';
