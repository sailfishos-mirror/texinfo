 ...
 *3 @chapter C27 l5 {chap}
     ...
     *@item C1 l21
      ...
      *line_arg C1
      ...
      |spaces_after_argument:
       ...
       {avar--b}
     *inter_item C3
      *10 index_entry_command@cindex C1 l22
      |INFO
      |command_name:{cindex}
      |spaces_before_argument:
       |{ }
     ...
     *@item C1 l37
      ...
      *line_arg C1
      ...
      |spaces_after_argument:
       ...
       {a}
     *inter_item C1
      *13 index_entry_command@cindex C1 l38
      |INFO
      |command_name:{cindex}
      |spaces_before_argument:
       |{ }
  ...
  *14 @table C3 l43
   ...
   *table_entry C2
    *table_term C3
     *16 index_entry_command@cindex C1 l44
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
  ...
  *17 @table C4 l50
   ...
   *arguments_line C1
    *block_line_arg C1
     ...
     *18 @code l50
   *before_item C2
    *19 index_entry_command@cindex C1 l51
    |INFO
    |command_name:{cindex}
    |spaces_before_argument:
     |{ }
  ...
  *20 @table C3 l56
   ...
   *table_entry C2
    *table_term C3
     *22 index_entry_command@cindex C1 l57
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
  ...
  *23 @table C4 l63
   ...
   *arguments_line C1
    *block_line_arg C1
     ...
     *24 @samp l63
   *before_item C2
    *25 index_entry_command@cindex C1 l64
    |INFO
    |command_name:{cindex}
    |spaces_before_argument:
     |{ }
  ...
  *26 @table C4 l69
   ...
   *before_item C3
    {empty_line:\\n}
    *28 index_entry_command@cindex C1 l71
    |INFO
    |command_name:{cindex}
    |spaces_before_argument:
     |{ }
  ...
  *29 @table C4 l76
   ...
   *arguments_line C1
    *block_line_arg C1
     ...
     *30 @samp l76
   *before_item C2
    *31 index_entry_command@cindex C1 l77
    |INFO
    |command_name:{cindex}
    |spaces_before_argument:
     |{ }
  ...
  *32 @table C4 l82
   ...
   *table_entry C1
    *table_term C2
     *34 index_entry_command@cindex C1 l84
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
  ...
  *35 @table C3 l88
   ...
   *table_entry C1
    *table_term C5
     *37 index_entry_command@cindex C1 l89
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
     ...
     *@c C1
      {rawline_arg: commant\\n}
     *38 index_entry_command@cindex C1 l91
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
      ...
      *line_arg C1
      ...
      |spaces_after_argument:
       |{\\n}
       {second}
     *39 index_entry_command@cindex C1 l92
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
