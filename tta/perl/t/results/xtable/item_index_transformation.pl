 ...
 *1 @chapter C9 l2 {Chapter}
     ...
     *4 index_entry_command@cindex C1 l9
      ...
      *line_arg C1
      ...
      |spaces_after_argument:
       |{\\n}
       {After1}
     *5 index_entry_command@cindex C1 l10
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
      ...
      *line_arg C1
      ...
      |spaces_after_argument:
       |{\\n}
       {After2}
     *6 index_entry_command@cindex C1 l5
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
     ...
     *9 index_entry_command@cindex C1 l20
      ...
      *line_arg C1
      ...
      |spaces_after_argument:
       |{\\n}
       {after1}
     *10 index_entry_command@cindex C1 l21
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
  ...
  *11 @table C4 l27
   ...
   *table_entry C2
    *table_term C4
     *13 index_entry_command@cindex C1 l28
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
      ...
      *line_arg C1
      ...
      |spaces_after_argument:
       |{\\n}
       {before1}
     *14 index_entry_command@cindex C1 l29
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
  ...
  *15 @table C4 l37
   ...
   *table_entry C2
    *table_term C4
     *17 index_entry_command@cindex C1 l42
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
      ...
      *line_arg C1
      ...
      |spaces_after_argument:
       |{\\n}
       {after6}
     *18 index_entry_command@cindex C1 l43
     |INFO
     |command_name:{cindex}
     |spaces_before_argument:
      |{ }
