...
$result_texis{'documentscript_conversion'} = '
@copying
@defivar SSS BBB CCC
@end defivar
@end copying
...
$result_texts{'documentscript_conversion'} = '
...
$result_nodes_list{'documentscript_conversion'} = '1|Top
...
$result_sections_list{'documentscript_conversion'} = '1|top
...
$result_sectioning_root{'documentscript_conversion'} = 'level: -1
list:
 1|top
';

$result_headings_list{'documentscript_conversion'} = '';
...
$result_converted{'plaintext'}->{'documentscript_conversion'} = 'top
***

1 Chap
******

See f: Top.  A dp_s-(Akl)

 -- p_S-s-InstV-s of some: p_S-other ivar
...
$result_converted_sort_strings{'plaintext'}->{'documentscript_conversion'} = 'vr:
 BBB of SSS
 before l-o-l script
 other s-o-s some
 reset l-o-l after
...
$result_converted{'html'}->{'documentscript_conversion'} = '<!DOCTYPE html>
<html>
...
<p>See h_s-<a class="xref" href="#Top">f</a>.
<abbr class="abbr" title="Akl">A</abbr> (Akl)
</p>
<dl class="first-defcv first-defivar-alias-first-defcv def-block">
<dt class="defcv defivar-alias-defcv def-line" id="index-other-of-some"><span class="category-def">s-InstV-s h_S-of <code class="code">some</code>: </span><span><strong class="def-name">other</strong> <var class="def-var-arguments">ivar</var><a class="copiable-link" href="#index-other-of-some"> &para;</a></span></dt>
</dl>
...
$result_converted_sort_strings{'html'}->{'documentscript_conversion'} = 'vr:
 BBB of SSS
 before l-o-l script
 other s-o-s some
 reset l-o-l after
...
$result_converted{'docbook_doc'}->{'documentscript_conversion'} = '<?xml version="1.0"?>
...
<para>See d_s-<link linkend="Top">f</link>.
<abbrev>A</abbrev> dp_s-(Akl)
</para>
<synopsis><indexterm role="vr"><primary>other s-o-s some</primary></indexterm><phrase role="category"><emphasis role="bold">Instance Variable</emphasis>:</phrase> <ooclass><classname>some</classname></ooclass> <property>other</property> <emphasis role="arg">ivar</emphasis></synopsis>
...
$result_converted{'latex'}->{'documentscript_conversion'} = '\\documentclass{book}
\\usepackage{amsfonts}
\\usepackage{amsmath}
