...
$result_nodes_list{'documentlanguage_unknown'} = '1|Top
...
$result_sectioning_root{'documentlanguage_unknown'} = 'level: -1
list:
 1|top section
';
...
$result_indices_sort_strings{'documentlanguage_unknown'} = 'fn:
 name on class
';
