...
$result_nodes_list{'documentlanguage_option'} = '1|Top
...
$result_sectioning_root{'documentlanguage_option'} = 'level: -1
list:
 1|top section
';
...
$result_converted_sort_strings{'file_html'}->{'documentlanguage_option'} = 'fn:
 name de class
';

$result_converted_sort_strings{'file_info'}->{'documentlanguage_option'} = 'fn:
 name de class
';
