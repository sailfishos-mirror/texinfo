...
{\\raggedright {\\huge \\bfseries a title than is long, very long, veeeeeeeeeeeeeeeeery long, it seems to never stop and it is not so interesting only very long oh an end of line \\ifinner\\unskip\\space\\ignorespaces\\else\\leavevmode{}\\\\\\fi%
 and the title continue and keep on being unfinished until it is the end}}
