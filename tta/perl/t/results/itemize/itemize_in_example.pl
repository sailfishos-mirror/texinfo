...
$result_sections_list{'itemize_in_example'} = '';

$result_sectioning_root{'itemize_in_example'} = '';

$result_headings_list{'itemize_in_example'} = '';
...
$result_converted{'latex_text'}->{'itemize_in_example'} = '\\begin{document}
