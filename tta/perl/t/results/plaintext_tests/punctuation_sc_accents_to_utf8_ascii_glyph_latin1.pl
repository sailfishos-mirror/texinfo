   ...
   *@documentencoding C1 punctuation_small_case_accents_latin1.texi:l3
    ...
    *line_arg C1
    ...
    |spaces_after_argument:
     ...
     {ISO-8859-1}
   {empty_line:\\n}
 *0 @node C1 punctuation_small_case_accents_latin1.texi:l5
 |INFO
 |spaces_before_argument:
  |{ }
 |EXTRA
  ...
  *arguments_line C1
   *line_arg C1
   ...
   |spaces_after_argument:
    |{\\n}
    {top}
 *1 @top C2 punctuation_small_case_accents_latin1.texi:l6
 |INFO
 |spaces_before_argument:
  |{ }
 |EXTRA
  ...
  *arguments_line C1
   *line_arg C1
   ...
   |spaces_after_argument:
    ...
    {top section}
  {empty_line:\\n}
 *2 @node C1 punctuation_small_case_accents_latin1.texi:l8
 |INFO
 |spaces_before_argument:
  |{ }
 |EXTRA
  ...
  *arguments_line C1
   *line_arg C1
   ...
   |spaces_after_argument:
    |{\\n}
    {node chap}
 *3 @chapter C11 punctuation_small_case_accents_latin1.texi:l9
 |INFO
 |spaces_before_argument:
  |{ }
 |EXTRA
...
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'} = {
  'extra' => {
    'section_childs' => [
      {
        'cmdname' => 'top',
...
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'prev'} = $result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'up'} = $result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}{'extra'}{'section_childs'}[0]{'extra'}{'sectioning_root'} = $result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'};

$result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'} = [
  {
    'cmdname' => 'node',
    'extra' => {
      'associated_section' => {
...
$result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}[0];
$result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}[0];
$result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}[1] = $result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'}[0]{'extra'}{'node_directions'}{'next'};

$result_menus{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'} = [
  {
    'extra' => {
      'normalized' => 'Top'
    }
...
$result_floats{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'} = {};
