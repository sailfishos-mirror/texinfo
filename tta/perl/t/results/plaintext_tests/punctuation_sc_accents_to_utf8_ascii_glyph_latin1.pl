...
$result_sections_list{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'} = '1|top section
...
$result_sectioning_root{'punctuation_sc_accents_to_utf8_ascii_glyph_latin1'} = 'level: -1
list:
 1|top section
';
