...
$result_tree_text{'punctuation_sc_accents_disable_encoding_latin1'} = '*document_root C5
...
$result_sections_list{'punctuation_sc_accents_disable_encoding_latin1'} = '1|top section
...
$result_sectioning_root{'punctuation_sc_accents_disable_encoding_latin1'} = 'level: -1
list:
 1|top section
';
