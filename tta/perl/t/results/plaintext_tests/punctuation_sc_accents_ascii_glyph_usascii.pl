...
$result_sections_list{'punctuation_sc_accents_ascii_glyph_usascii'} = '1|top section
...
$result_sectioning_root{'punctuation_sc_accents_ascii_glyph_usascii'} = 'level: -1
list:
 1|top section
';
