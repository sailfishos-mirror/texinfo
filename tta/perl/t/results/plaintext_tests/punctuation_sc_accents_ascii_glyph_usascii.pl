...
$result_tree_text{'punctuation_sc_accents_ascii_glyph_usascii'} = '*document_root C5
...
$result_sectioning{'punctuation_sc_accents_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'punctuation_sc_accents_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0];
...
$result_nodes{'punctuation_sc_accents_ascii_glyph_usascii'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'punctuation_sc_accents_ascii_glyph_usascii'}[0];
$result_nodes{'punctuation_sc_accents_ascii_glyph_usascii'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'punctuation_sc_accents_ascii_glyph_usascii'}[0];
$result_nodes{'punctuation_sc_accents_ascii_glyph_usascii'}[1] = $result_nodes{'punctuation_sc_accents_ascii_glyph_usascii'}[0]{'extra'}{'node_directions'}{'next'};
