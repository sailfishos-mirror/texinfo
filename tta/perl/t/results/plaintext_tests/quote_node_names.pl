...
$result_errors{'quote_node_names'} = '* W nodequote.texi:l36|node up pointer for `normal node\' is `(man_ual)direct::i.on\' but up is `Top\' in menu
...
$result_sectioning_root{'quote_node_names'} = 'level: -1
list:
 1|
';
