...
$result_tree_text{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'} = '*document_root C5
...
$result_texis{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'} = '\\input texinfo
...
$result_texts{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'} = '
top section
***********
...
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'} = {
  'extra' => {
    'section_childs' => [
      {
        'cmdname' => 'top',
...
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'section_directions'}{'up'} = $result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'prev'} = $result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'up'} = $result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0];
$result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}{'extra'}{'section_childs'}[0]{'extra'}{'sectioning_root'} = $result_sectioning{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'};

$result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'} = [
  {
    'cmdname' => 'node',
    'extra' => {
      'associated_section' => {
...
$result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}[0];
$result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}[0];
$result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}[1] = $result_nodes{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'}[0]{'extra'}{'node_directions'}{'next'};

$result_menus{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'} = [
  {
    'extra' => {
      'normalized' => 'Top'
    }
...
$result_errors{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'} = [];


$result_floats{'punctuation_sc_accents_to_utf8_ascii_glyph_usascii'} = {};
