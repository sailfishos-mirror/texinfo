...
$result_tree_text{'punctuation_sc_accents_default_usascii'} = '*document_root C5
...
$result_sections_list{'punctuation_sc_accents_default_usascii'} = '1|top section
...
$result_sectioning_root{'punctuation_sc_accents_default_usascii'} = 'level: -1
list:
 1|top section
';
