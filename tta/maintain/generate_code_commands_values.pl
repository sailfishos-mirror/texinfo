...
print UNIC "/* NOTE included in unicode.c after unicode.h, which has types definitions */\n\n";
...
print TEXT "/* To include before substituted headers in convert_to_text.h */\n";
