...
/* NOTE included in builtin_commands.c after builtin_commands.h, which has types definitions */


const COMMAND command_data[] = {
{0, 0, 0, 0, 0},
{"\t", CF_nobrace, CF_formatted_nobrace, NOBRACE_symbol, 0},
{"\n", CF_nobrace, CF_formatted_nobrace, NOBRACE_symbol, 0},
{"\x20", CF_nobrace, CF_formatted_nobrace, NOBRACE_symbol, 0},
{"!", CF_nobrace, CF_formatted_nobrace, NOBRACE_symbol, 0},
{"\"", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
{"&", CF_nobrace, CF_formatted_nobrace, NOBRACE_symbol, 0},
{"'", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
...
{"H", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
...
{"author", CF_line | CF_no_paragraph | CF_global | CF_contain_basic_inline, CF_formatted_line | CF_metadata, LINE_line, 1},
...
{"copying", CF_block | CF_no_paragraph | CF_close_paragraph | CF_global_unique | CF_preamble, CF_metadata, BLOCK_region, 0},
...
{"defcv", CF_block | CF_no_paragraph | CF_def | CF_def_class_variable | CF_contain_basic_inline | CF_close_paragraph, 0, BLOCK_def, 0},
...
{"definfoenclose_command", CF_brace | CF_internal, 0, BRACE_style_other, 1},
{"defivar", CF_block | CF_no_paragraph | CF_def | CF_def_class_variable | CF_contain_basic_inline | CF_def_alias | CF_close_paragraph, 0, BLOCK_def, 0},
...
{"defmethod", CF_block | CF_no_paragraph | CF_def | CF_def_class_method | CF_contain_basic_inline | CF_def_alias | CF_close_paragraph, 0, BLOCK_def, 0},
{"defmethodx", CF_line | CF_no_paragraph | CF_def | CF_contain_basic_inline | CF_def_alias | CF_close_paragraph, 0, LINE_line, 1},
{"defop", CF_block | CF_no_paragraph | CF_def | CF_def_class_method | CF_contain_basic_inline | CF_close_paragraph, 0, BLOCK_def, 0},
...
{"deftypecv", CF_block | CF_no_paragraph | CF_def | CF_def_class_variable | CF_contain_basic_inline | CF_close_paragraph, 0, BLOCK_def, 0},
...
{"deftypeivar", CF_block | CF_no_paragraph | CF_def | CF_def_class_variable | CF_contain_basic_inline | CF_def_alias | CF_close_paragraph, 0, BLOCK_def, 0},
...
{"deftypemethod", CF_block | CF_no_paragraph | CF_def | CF_def_class_method | CF_contain_basic_inline | CF_def_alias | CF_close_paragraph, 0, BLOCK_def, 0},
{"deftypemethodx", CF_line | CF_no_paragraph | CF_def | CF_contain_basic_inline | CF_def_alias | CF_close_paragraph, 0, LINE_line, 1},
{"deftypeop", CF_block | CF_no_paragraph | CF_def | CF_def_class_method | CF_contain_basic_inline | CF_close_paragraph, 0, BLOCK_def, 0},
...
{"documentdescription", CF_block | CF_no_paragraph | CF_close_paragraph | CF_global_unique | CF_preamble, CF_metadata, BLOCK_region, 0},
...
{"documentlanguage", CF_line | CF_no_paragraph | CF_global | CF_preamble | CF_contain_plain_text, CF_metadata, LINE_text, 1},
{"documentlanguagevariant", CF_line | CF_no_paragraph | CF_global | CF_preamble | CF_contain_plain_text | CF_variadic, CF_metadata, LINE_line, 1},
{"documentscript", CF_line | CF_no_paragraph | CF_global | CF_preamble | CF_contain_plain_text, CF_metadata, LINE_text, 1},
{"dotaccent", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
{"dotless", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
...
{"example", CF_block | CF_no_paragraph | CF_close_paragraph | CF_preformatted | CF_variadic | CF_contain_basic_inline, CF_preformatted_code, BLOCK_preformatted, 0},
...
{"flushleft", CF_block | CF_no_paragraph | CF_close_paragraph, 0, BLOCK_other, 0},
{"flushright", CF_block | CF_no_paragraph | CF_close_paragraph, 0, BLOCK_other, 0},
...
{"group", CF_block | CF_no_paragraph | CF_close_paragraph, 0, BLOCK_other, 0},
...
{"ifepub", CF_block | CF_no_paragraph, 0, BLOCK_conditional, 0},
...
{"ifnotepub", CF_block | CF_no_paragraph, 0, BLOCK_conditional, 0},
...
{"ifnotxml", CF_block | CF_no_paragraph | CF_deprecated, 0, BLOCK_conditional, 0},
...
{"ifxml", CF_block | CF_no_paragraph | CF_deprecated, 0, BLOCK_conditional, 0},
...
{"indentedblock", CF_block | CF_no_paragraph | CF_close_paragraph, 0, BLOCK_other, 0},
{"index_entry_command", CF_line | CF_no_paragraph | CF_index_entry_command | CF_contain_basic_inline | CF_internal, 0, LINE_line, 1},
...
{"nodedescriptionblock", CF_block | CF_no_paragraph | CF_close_paragraph, CF_non_formatted_block, BLOCK_other, 0},
...
{"oe", CF_brace, CF_letter_no_arg, BRACE_noarg, 0},
{"ogonek", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
...
{"publication", CF_block | CF_no_paragraph | CF_close_paragraph | CF_global_unique | CF_preamble, CF_metadata, BLOCK_region, 0},
...
{"raggedright", CF_block | CF_no_paragraph | CF_close_paragraph, 0, BLOCK_other, 0},
...
{"ringaccent", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
...
{"settitle", CF_line | CF_no_paragraph | CF_global_unique | CF_preamble | CF_contain_basic_inline, CF_metadata, LINE_line, 1},
...
{"shorttitlepage", CF_line | CF_no_paragraph | CF_global_unique | CF_preamble | CF_contain_basic_inline, CF_metadata, LINE_line, 1},
...
{"smallindentedblock", CF_block | CF_no_paragraph | CF_close_paragraph, 0, BLOCK_other, 0},
...
{"subtitle", CF_line | CF_no_paragraph | CF_global | CF_contain_basic_inline, CF_formatted_line | CF_metadata, LINE_line, 1},
...
{"tieaccent", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
{"tindex", CF_line | CF_no_paragraph | CF_index_entry_command | CF_contain_basic_inline, 0, LINE_line, 1},
{"title", CF_line | CF_no_paragraph | CF_global_unique | CF_contain_basic_inline, CF_formatted_line | CF_metadata, LINE_line, 1},
{"titlefont", CF_brace | CF_close_paragraph | CF_global | CF_contain_basic_inline | CF_no_paragraph, CF_metadata, BRACE_other, 1},
{"titlepage", CF_block | CF_no_paragraph | CF_close_paragraph | CF_global_unique | CF_preamble, CF_metadata, BLOCK_region, 0},
...
{"txiinternalvalue", CF_brace | CF_internal, 0, BRACE_special, 1},
{"u", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
{"ubaraccent", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
{"udotaccent", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
...
{"v", CF_brace | CF_contain_plain_text, 0, BRACE_accent, 1},
...
{"xml", CF_block | CF_no_paragraph | CF_preamble | CF_deprecated, 0, BLOCK_format_raw, 0},
