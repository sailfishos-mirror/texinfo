...
END {
    ...
    print "/* NOTE included in builtin_commands.c after builtin_commands.h, which has types definitions */" "\n\n" > CD
    print "const COMMAND command_data[] = {" > CD
    ...
    print "   ELEMENT_LIST language_commands;\n" > GCT
