...
BEGIN {
    ...
    print "/* This file automatically generated by element_types.awk */" > TDC
    print ""                                                             > TDC
    print "#include \"types_data.h\""                                    > TDC
    print ""                                                             > TDC
    print "const TYPE_DATA type_data[] = {"                              > TDC
    print "{0, 0, 0},"                                                   > TDC
}
...
END {
    ...
    for (line_idx in types) {
        ...
        print "{\"" t "\", " flags ", " elt_info_number "}," > TDC
    }
    print "};" > TDC
}
