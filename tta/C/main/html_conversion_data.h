...
extern const char *special_unit_info_type_names[CUSTOMIZED_SPECIAL_UNIT_INFO_TYPE_NR];
...
#define DEFAULT_GLOBAL_DIRECTION_LAST_IDX D_Last
#define DEFAULT_TEXT_DIRECTION_LAST_IDX D_Space
