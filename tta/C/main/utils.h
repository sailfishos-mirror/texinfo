...
const char *txi_in_language_regions (register const char *str,
                                     register size_t len);
/* generated by gperf in txi_documentlanguage_scripts.c */
typedef struct TXI_DOCUMENT_SCRIPT {
    const char *name;
    const char *code;
} TXI_DOCUMENT_SCRIPT;
const TXI_DOCUMENT_SCRIPT *txi_in_language_scripts (register const char *str,
                                        register size_t len);
/* generated by gperf in txi_documentlanguage_variants.c */
const char *txi_in_language_variants (register const char *str,
                                      register size_t len);
...
const char *analyze_documentscript_argument (const char *text,
                                             int *valid_script);
const char *analyze_documentlanguagevariant_argument_e (const ELEMENT *element,
                                            int *valid_variant,
                                            int *surplus_arg);
