...
setup_sortable_options (OPTION **to_sort, OPTIONS *options)
{
  ...
  to_sort[45] = &options->EPUB_CREATE_CONTAINER_FILE;   /* converter_customization */
  to_sort[46] = &options->EPUB_KEEP_CONTAINER_FOLDER;   /* converter_customization */
  ...
  to_sort[50] = &options->EXTERNAL_CROSSREF_EXTENSION;   /* converter_customization */
  to_sort[51] = &options->EXTERNAL_CROSSREF_SPLIT;   /* converter_customization */
  ...
  to_sort[55] = &options->FOOTNOTE_END_HEADER_LEVEL;   /* converter_customization */
  to_sort[56] = &options->FOOTNOTE_SEPARATE_HEADER_LEVEL;   /* converter_customization */
  to_sort[57] = &options->FORCE;   /* program_cmdline */
  to_sort[58] = &options->FORMAT_MENU;   /* program_cmdline */
  to_sort[59] = &options->HANDLER_FATAL_ERROR_LEVEL;   /* converter_customization */
  ...
  to_sort[63] = &options->HIGHLIGHT_SYNTAX_DEFAULT_LANGUAGE;   /* converter_customization */
  ...
  to_sort[67] = &options->HTML_ROOT_ELEMENT_ATTRIBUTES;   /* converter_customization */
  to_sort[68] = &options->ICONS;   /* converter_customization */
  to_sort[69] = &options->IGNORE_REF_TO_TOP_NODE_UP;   /* converter_customization */
  ...
  to_sort[73] = &options->INDENTED_BLOCK_COMMANDS_IN_TABLE;   /* converter_customization */
  to_sort[74] = &options->INDEX_ENTRY_COLON;   /* converter_customization */
  to_sort[75] = &options->INDEX_SPECIAL_CHARS_WARNING;   /* converter_customization */
  to_sort[76] = &options->INFO_JS_DIR;   /* converter_customization */
  to_sort[77] = &options->INFO_MATH_IMAGES;   /* converter_customization */
  to_sort[78] = &options->INFO_SPECIAL_CHARS_QUOTE;   /* converter_customization */
  to_sort[79] = &options->INFO_SPECIAL_CHARS_WARNING;   /* converter_customization */
  to_sort[80] = &options->INLINE_CSS_STYLE;   /* converter_customization */
  to_sort[81] = &options->INPUT_FILE_NAME_ENCODING;   /* converter_customization */
  ...
  to_sort[110] = &options->NO_CUSTOM_HTML_ATTRIBUTE;   /* converter_customization */
  to_sort[111] = &options->NO_INDEX;   /* parser */
  to_sort[112] = &options->NO_NUMBER_FOOTNOTE_SYMBOL;   /* converter_customization */
  ...
  to_sort[118] = &options->OPEN_DOUBLE_QUOTE_SYMBOL;   /* converter_customization */
  ...
  to_sort[123] = &options->OUTPUT_FILE_NAME_ENCODING;   /* converter_customization */
  ...
  to_sort[171] = &options->USE_NEXT_HEADING_FOR_LONE_NODE;   /* converter_customization */
