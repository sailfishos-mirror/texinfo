...
setup_sortable_options (OPTION **to_sort, OPTIONS *options)
{
  ...
  to_sort[67] = &options->HTML_MATH;   /* converter_customization */
  to_sort[68] = &options->HTML_ROOT_ELEMENT_ATTRIBUTES;   /* converter_customization */
  to_sort[69] = &options->ICONS;   /* converter_customization */
  to_sort[70] = &options->IGNORE_REF_TO_TOP_NODE_UP;   /* converter_customization */
  to_sort[71] = &options->IGNORE_SPACE_AFTER_BRACED_COMMAND_NAME;   /* parser */
  to_sort[72] = &options->IMAGE_LINK_PREFIX;   /* converter_customization */
  to_sort[73] = &options->INCLUDE_DIRECTORIES;   /* array_cmdline */
  to_sort[74] = &options->INDENTED_BLOCK_COMMANDS_IN_TABLE;   /* converter_customization */
  to_sort[75] = &options->INDEX_ENTRY_COLON;   /* converter_customization */
  to_sort[76] = &options->INDEX_SPECIAL_CHARS_WARNING;   /* converter_customization */
  to_sort[77] = &options->INFO_JS_DIR;   /* converter_customization */
  to_sort[78] = &options->INFO_MATH_IMAGES;   /* converter_customization */
  to_sort[79] = &options->INFO_SPECIAL_CHARS_QUOTE;   /* converter_customization */
  to_sort[80] = &options->INFO_SPECIAL_CHARS_WARNING;   /* converter_customization */
  to_sort[81] = &options->INLINE_CSS_STYLE;   /* converter_customization */
  to_sort[82] = &options->INPUT_FILE_NAME_ENCODING;   /* converter_customization */
  to_sort[83] = &options->INTERNAL_LINKS;   /* program_cmdline */
  to_sort[84] = &options->JS_WEBLABELS;   /* converter_customization */
  to_sort[85] = &options->JS_WEBLABELS_FILE;   /* converter_customization */
  to_sort[86] = &options->L2H_CLEAN;   /* converter_customization */
  to_sort[87] = &options->L2H_FILE;   /* converter_customization */
  to_sort[88] = &options->L2H_HTML_VERSION;   /* converter_customization */
  to_sort[89] = &options->L2H_L2H;   /* converter_customization */
  to_sort[90] = &options->L2H_SKIP;   /* converter_customization */
  to_sort[91] = &options->L2H_TMP;   /* converter_customization */
  to_sort[92] = &options->LATEX_FLOATS_FILE_EXTENSION;   /* converter_customization */
  to_sort[93] = &options->LINKS_DIRECTIONS;   /* converter_other */
  to_sort[94] = &options->LOCALE_ENCODING;   /* converter_customization */
  to_sort[95] = &options->MACRO_EXPAND;   /* program_cmdline */
  to_sort[96] = &options->MATHJAX_CONFIGURATION;   /* converter_customization */
  to_sort[97] = &options->MATHJAX_SCRIPT;   /* converter_customization */
  to_sort[98] = &options->MATHJAX_SOURCE;   /* converter_customization */
  to_sort[99] = &options->MAX_HEADER_LEVEL;   /* converter_customization */
  to_sort[100] = &options->MAX_MACRO_CALL_NESTING;   /* parser */
  to_sort[101] = &options->MENU_ENTRY_COLON;   /* converter_customization */
  to_sort[102] = &options->MENU_SYMBOL;   /* converter_customization */
  to_sort[103] = &options->MESSAGE_ENCODING;   /* converter_customization */
  to_sort[104] = &options->MISC_BUTTONS;   /* converter_other */
  to_sort[105] = &options->MONOLITHIC;   /* converter_customization */
  to_sort[106] = &options->NODE_FILES;   /* converter_cmdline */
  to_sort[107] = &options->NODE_FOOTER_BUTTONS;   /* converter_other */
  to_sort[108] = &options->NODE_NAME_IN_INDEX;   /* converter_customization */
  to_sort[109] = &options->NODE_NAME_IN_MENU;   /* converter_customization */
  to_sort[110] = &options->NO_CSS;   /* converter_customization */
  to_sort[111] = &options->NO_CUSTOM_HTML_ATTRIBUTE;   /* converter_customization */
  to_sort[112] = &options->NO_INDEX;   /* parser */
  to_sort[113] = &options->NO_NUMBER_FOOTNOTE_SYMBOL;   /* converter_customization */
  to_sort[114] = &options->NO_TOP_NODE_OUTPUT;   /* converter_customization */
  to_sort[115] = &options->NO_USER_COMMANDS;   /* parser */
  to_sort[116] = &options->NO_WARN;   /* program_cmdline */
  to_sort[117] = &options->NUMBER_FOOTNOTES;   /* converter_cmdline */
  to_sort[118] = &options->NUMBER_SECTIONS;   /* converter_cmdline */
  to_sort[119] = &options->OPEN_DOUBLE_QUOTE_SYMBOL;   /* converter_customization */
  to_sort[120] = &options->OPEN_QUOTE_SYMBOL;   /* converter_customization */
  to_sort[121] = &options->OUTFILE;   /* converter_cmdline */
  to_sort[122] = &options->OUTPUT_CHARACTERS;   /* converter_customization */
  to_sort[123] = &options->OUTPUT_ENCODING_NAME;   /* converter_customization */
  to_sort[124] = &options->OUTPUT_FILE_NAME_ENCODING;   /* converter_customization */
  ...
  to_sort[135] = &options->PROGRAM_NAME_IN_FOOTER;   /* converter_customization */
  ...
  to_sort[143] = &options->SORT_ELEMENT_COUNT_WORDS;   /* program_customization */
  ...
  to_sort[167] = &options->TXI_MARKUP_NO_SECTION_EXTENT;   /* converter_customization */
  ...
  to_sort[174] = &options->USE_SETFILENAME_EXTENSION;   /* converter_customization */
  to_sort[175] = &options->USE_TITLEPAGE_FOR_TITLE;   /* converter_customization */
  to_sort[176] = &options->USE_UNICODE_COLLATION;   /* converter_customization */
  to_sort[177] = &options->USE_UNIDECODE;   /* converter_customization */
  to_sort[178] = &options->USE_XML_SYNTAX;   /* converter_customization */
  to_sort[179] = &options->VERBOSE;   /* converter_cmdline */
  to_sort[180] = &options->VERTICAL_HEAD_NAVIGATION;   /* converter_customization */
  to_sort[181] = &options->WORDS_IN_PAGE;   /* converter_customization */
  to_sort[182] = &options->XREF_USE_FLOAT_LABEL;   /* converter_customization */
  to_sort[183] = &options->XREF_USE_NODE_NAME_ARG;   /* converter_customization */
  to_sort[184] = &options->XS_EXTERNAL_CONVERSION;   /* converter_customization */
  to_sort[185] = &options->XS_EXTERNAL_FORMATTING;   /* converter_customization */
  to_sort[186] = &options->XS_STRXFRM_COLLATION_LOCALE;   /* converter_customization */
  to_sort[187] = &options->_DOCBOOK_PIECE;   /* converter_customization */
  ...
  to_sort[195] = &options->codequotebacktick;   /* multiple_at_command */
  to_sort[196] = &options->codequoteundirected;   /* multiple_at_command */
  to_sort[197] = &options->contents;   /* multiple_at_command */
  to_sort[198] = &options->deftypefnnewline;   /* multiple_at_command */
  to_sort[199] = &options->documentdescription;   /* unique_at_command */
  to_sort[200] = &options->documentencoding;   /* multiple_at_command */
  to_sort[201] = &options->documentlanguage;   /* multiple_at_command */
  to_sort[202] = &options->evenfooting;   /* multiple_at_command */
  to_sort[203] = &options->evenfootingmarks;   /* unique_at_command */
  to_sort[204] = &options->evenheading;   /* multiple_at_command */
  to_sort[205] = &options->evenheadingmarks;   /* unique_at_command */
  to_sort[206] = &options->everyfooting;   /* multiple_at_command */
  to_sort[207] = &options->everyfootingmarks;   /* unique_at_command */
  to_sort[208] = &options->everyheading;   /* multiple_at_command */
  to_sort[209] = &options->everyheadingmarks;   /* unique_at_command */
  to_sort[210] = &options->exampleindent;   /* multiple_at_command */
  to_sort[211] = &options->firstparagraphindent;   /* multiple_at_command */
  to_sort[212] = &options->fonttextsize;   /* unique_at_command */
  to_sort[213] = &options->footnotestyle;   /* unique_at_command */
  to_sort[214] = &options->frenchspacing;   /* multiple_at_command */
  to_sort[215] = &options->headings;   /* multiple_at_command */
  to_sort[216] = &options->kbdinputstyle;   /* multiple_at_command */
  to_sort[217] = &options->microtype;   /* multiple_at_command */
  to_sort[218] = &options->novalidate;   /* unique_at_command */
  to_sort[219] = &options->oddfooting;   /* multiple_at_command */
  to_sort[220] = &options->oddfootingmarks;   /* unique_at_command */
  to_sort[221] = &options->oddheading;   /* multiple_at_command */
  to_sort[222] = &options->oddheadingmarks;   /* unique_at_command */
  to_sort[223] = &options->pagesizes;   /* unique_at_command */
  to_sort[224] = &options->paragraphindent;   /* multiple_at_command */
  to_sort[225] = &options->setchapternewpage;   /* unique_at_command */
  to_sort[226] = &options->setfilename;   /* unique_at_command */
  to_sort[227] = &options->shortcontents;   /* multiple_at_command */
  to_sort[228] = &options->smallbook;   /* unique_at_command */
  to_sort[229] = &options->summarycontents;   /* multiple_at_command */
  to_sort[230] = &options->urefbreakstyle;   /* multiple_at_command */
  to_sort[231] = &options->xrefautomaticsectiontitle;   /* multiple_at_command */
}
                           ...
                           const OPTIONS *options)
{
  ...
  options_command_map[6].option_number = options->codequotebacktick.number;
  options_command_map[6].cmd = CM_codequotebacktick;    /* (multiple_at_command) */
  options_command_map[7].option_number = options->codequoteundirected.number;
  options_command_map[7].cmd = CM_codequoteundirected;    /* (multiple_at_command) */
  options_command_map[8].option_number = options->contents.number;
  options_command_map[8].cmd = CM_contents;    /* (multiple_at_command) */
  options_command_map[9].option_number = options->deftypefnnewline.number;
  options_command_map[9].cmd = CM_deftypefnnewline;    /* (multiple_at_command) */
  options_command_map[10].option_number = options->documentdescription.number;
  options_command_map[10].cmd = CM_documentdescription;    /* (unique_at_command) */
  options_command_map[11].option_number = options->documentencoding.number;
  options_command_map[11].cmd = CM_documentencoding;    /* (multiple_at_command) */
  options_command_map[12].option_number = options->documentlanguage.number;
  options_command_map[12].cmd = CM_documentlanguage;    /* (multiple_at_command) */
  options_command_map[13].option_number = options->evenfooting.number;
  options_command_map[13].cmd = CM_evenfooting;    /* (multiple_at_command) */
  options_command_map[14].option_number = options->evenfootingmarks.number;
  options_command_map[14].cmd = CM_evenfootingmarks;    /* (unique_at_command) */
  options_command_map[15].option_number = options->evenheading.number;
  options_command_map[15].cmd = CM_evenheading;    /* (multiple_at_command) */
  options_command_map[16].option_number = options->evenheadingmarks.number;
  options_command_map[16].cmd = CM_evenheadingmarks;    /* (unique_at_command) */
  options_command_map[17].option_number = options->everyfooting.number;
  options_command_map[17].cmd = CM_everyfooting;    /* (multiple_at_command) */
  options_command_map[18].option_number = options->everyfootingmarks.number;
  options_command_map[18].cmd = CM_everyfootingmarks;    /* (unique_at_command) */
  options_command_map[19].option_number = options->everyheading.number;
  options_command_map[19].cmd = CM_everyheading;    /* (multiple_at_command) */
  options_command_map[20].option_number = options->everyheadingmarks.number;
  options_command_map[20].cmd = CM_everyheadingmarks;    /* (unique_at_command) */
  options_command_map[21].option_number = options->exampleindent.number;
  options_command_map[21].cmd = CM_exampleindent;    /* (multiple_at_command) */
  options_command_map[22].option_number = options->firstparagraphindent.number;
  options_command_map[22].cmd = CM_firstparagraphindent;    /* (multiple_at_command) */
  options_command_map[23].option_number = options->fonttextsize.number;
  options_command_map[23].cmd = CM_fonttextsize;    /* (unique_at_command) */
  options_command_map[24].option_number = options->footnotestyle.number;
  options_command_map[24].cmd = CM_footnotestyle;    /* (unique_at_command) */
  options_command_map[25].option_number = options->frenchspacing.number;
  options_command_map[25].cmd = CM_frenchspacing;    /* (multiple_at_command) */
  options_command_map[26].option_number = options->headings.number;
  options_command_map[26].cmd = CM_headings;    /* (multiple_at_command) */
  options_command_map[27].option_number = options->kbdinputstyle.number;
  options_command_map[27].cmd = CM_kbdinputstyle;    /* (multiple_at_command) */
  options_command_map[28].option_number = options->microtype.number;
  options_command_map[28].cmd = CM_microtype;    /* (multiple_at_command) */
  options_command_map[29].option_number = options->novalidate.number;
  options_command_map[29].cmd = CM_novalidate;    /* (unique_at_command) */
  options_command_map[30].option_number = options->oddfooting.number;
  options_command_map[30].cmd = CM_oddfooting;    /* (multiple_at_command) */
  options_command_map[31].option_number = options->oddfootingmarks.number;
  options_command_map[31].cmd = CM_oddfootingmarks;    /* (unique_at_command) */
  options_command_map[32].option_number = options->oddheading.number;
  options_command_map[32].cmd = CM_oddheading;    /* (multiple_at_command) */
  options_command_map[33].option_number = options->oddheadingmarks.number;
  options_command_map[33].cmd = CM_oddheadingmarks;    /* (unique_at_command) */
  options_command_map[34].option_number = options->pagesizes.number;
  options_command_map[34].cmd = CM_pagesizes;    /* (unique_at_command) */
  options_command_map[35].option_number = options->paragraphindent.number;
  options_command_map[35].cmd = CM_paragraphindent;    /* (multiple_at_command) */
  options_command_map[36].option_number = options->setchapternewpage.number;
  options_command_map[36].cmd = CM_setchapternewpage;    /* (unique_at_command) */
  options_command_map[37].option_number = options->setfilename.number;
  options_command_map[37].cmd = CM_setfilename;    /* (unique_at_command) */
  options_command_map[38].option_number = options->shortcontents.number;
  options_command_map[38].cmd = CM_shortcontents;    /* (multiple_at_command) */
  options_command_map[39].option_number = options->smallbook.number;
  options_command_map[39].cmd = CM_smallbook;    /* (unique_at_command) */
  options_command_map[40].option_number = options->summarycontents.number;
  options_command_map[40].cmd = CM_summarycontents;    /* (multiple_at_command) */
  options_command_map[41].option_number = options->urefbreakstyle.number;
  options_command_map[41].cmd = CM_urefbreakstyle;    /* (multiple_at_command) */
  options_command_map[42].option_number = options->xrefautomaticsectiontitle.number;
  options_command_map[42].cmd = CM_xrefautomaticsectiontitle;    /* (multiple_at_command) */
}
