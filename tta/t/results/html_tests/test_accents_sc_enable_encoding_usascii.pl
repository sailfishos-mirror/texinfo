...
$result_sectioning{'test_accents_sc_enable_encoding_usascii'}{'extra'}{'section_childs'}[0]{'extra'}{'section_childs'}[0]{'extra'}{'toplevel_directions'}{'up'} = $result_sectioning{'test_accents_sc_enable_encoding_usascii'}{'extra'}{'section_childs'}[0];
$result_sectioning{'test_accents_sc_enable_encoding_usascii'}{'extra'}{'section_childs'}[0]{'extra'}{'sectioning_root'} = $result_sectioning{'test_accents_sc_enable_encoding_usascii'};
...
$result_nodes{'test_accents_sc_enable_encoding_usascii'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'prev'} = $result_nodes{'test_accents_sc_enable_encoding_usascii'}[0];
$result_nodes{'test_accents_sc_enable_encoding_usascii'}[0]{'extra'}{'node_directions'}{'next'}{'extra'}{'node_directions'}{'up'} = $result_nodes{'test_accents_sc_enable_encoding_usascii'}[0];
$result_nodes{'test_accents_sc_enable_encoding_usascii'}[1] = $result_nodes{'test_accents_sc_enable_encoding_usascii'}[0]{'extra'}{'node_directions'}{'next'};
