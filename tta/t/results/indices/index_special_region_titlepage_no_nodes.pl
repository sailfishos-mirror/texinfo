...
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[3]{'contents'}[6]{'extra'}{'element_node'} = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[1];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[3]{'contents'}[11]{'contents'}[2]{'contents'}[0]{'contents'}[0]{'extra'}{'element_node'} = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[1];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[3]{'contents'}[11]{'extra'}{'command_as_argument'} = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[3]{'contents'}[11]{'contents'}[0]{'contents'}[0]{'contents'}[0];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[3]{'contents'}[13]{'contents'}[1]{'contents'}[1]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[3]{'contents'}[13]{'contents'}[1]{'contents'}[1]{'contents'}[0];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[4]{'extra'}{'element_node'} = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[4];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[6]{'extra'}{'element_node'} = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[4];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[8]{'contents'}[0]{'contents'}[0]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[8]{'contents'}[0]{'contents'}[0]{'contents'}[0];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[8]{'contents'}[2]{'contents'}[0]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[8]{'contents'}[2]{'contents'}[0]{'contents'}[0];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[10]{'contents'}[0]{'contents'}[0]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[10]{'contents'}[0]{'contents'}[0]{'contents'}[0];
$result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[10]{'contents'}[2]{'contents'}[0]{'extra'}{'node_content'}{'contents'}[0] = $result_trees{'index_special_region_titlepage_no_nodes'}{'contents'}[5]{'contents'}[10]{'contents'}[2]{'contents'}[0]{'contents'}[0];
