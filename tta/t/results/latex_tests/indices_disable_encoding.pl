...
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[7]{'extra'}{'element_node'} = $result_trees{'indices_disable_encoding'}{'contents'}[3];
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[9]{'extra'}{'element_node'} = $result_trees{'indices_disable_encoding'}{'contents'}[3];
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[9]{'extra'}{'subentry'}{'contents'}[0]{'contents'}[11] = $result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[9]{'extra'}{'seealso'};
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[9]{'extra'}{'subentry'}{'extra'}{'subentry_parent'} = $result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[9];
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[10] = $result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[9]{'extra'}{'subentry'};
...
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[12]{'extra'}{'element_node'} = $result_trees{'indices_disable_encoding'}{'contents'}[3];
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[16]{'extra'}{'element_node'} = $result_trees{'indices_disable_encoding'}{'contents'}[3];
$result_trees{'indices_disable_encoding'}{'contents'}[4]{'contents'}[18]{'extra'}{'element_node'} = $result_trees{'indices_disable_encoding'}{'contents'}[3];
