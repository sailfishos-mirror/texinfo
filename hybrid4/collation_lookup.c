...
static uint32_t collation_data_size = 0;

/* Load binary data from file */
static int load_data_file(const char *filename) {
...
/* Read header */
static void read_header(const uint8_t *data, Header *header) {
...
static int lookup_codepoint(const uint8_t *data, const Header *header,
                            uint32_t codepoint, 
                            CollationElement *elements, uint8_t *num_elements) {
...
/* Lookup sequence */
static int lookup_sequence(const uint8_t *data, const Header *header,
...
static void print_collation(const CollationElement *elements, uint8_t num_elements) {
